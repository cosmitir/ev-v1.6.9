...
public interface TimeMark {
    ...
    TimeMark mo3773minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo3774plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m3916plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m3915minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo3774plusLRDsOJo(Duration.m3832unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m3813isNegativeimpl(timeMark.mo3772elapsedNowUwyO8pc());
        }
