...
public final class DurationKt {
    ...
    private static final long m3906timesmvk6XK0(int i, long j) {
        return Duration.m3818timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk */
    private static final long m3905timeskIfJnKk(double d, long j) {
        return Duration.m3817timesUwyO8pc(j, d);
    }
    ...
    */
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m3780constructorimpl(j << 1);
    }

    public static final long durationOfMillis(long j) {
        return Duration.m3780constructorimpl((j << 1) + 1);
    }

    public static final long durationOf(long j, int i) {
        return Duration.m3780constructorimpl((j << 1) + i);
    }
