        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m3031contentEqualskV0jMPg(((UByteArray) t).m2549unboximpl(), ((UByteArray) t2).m2549unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m3028contentEqualsFGO6Aew(((UShortArray) t).m2809unboximpl(), ((UShortArray) t2).m2809unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m3029contentEqualsKJPZfPQ(((UIntArray) t).m2627unboximpl(), ((UIntArray) t2).m2627unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m3033contentEqualslec5QzE(((ULongArray) t).m2705unboximpl(), ((ULongArray) t2).m2705unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m3045contentToString2csIQuQ(uByteArray != null ? uByteArray.m2549unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                sb.append(UArraysKt.m3049contentToStringd6D3K8(uShortArray != null ? uShortArray.m2809unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                sb.append(UArraysKt.m3048contentToStringXUkPCBk(uIntArray != null ? uIntArray.m2627unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                sb.append(UArraysKt.m3051contentToStringuLth9ew(uLongArray != null ? uLongArray.m2705unboximpl() : null));
            } else {
