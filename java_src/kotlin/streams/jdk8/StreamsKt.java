...
public final class StreamsKt {
    ...
    public static final <T> Stream<T> asStream(final Sequence<? extends T> sequence) {
        ...
        Stream<T> stream = StreamSupport.stream(new Supplier() { // from class: kotlin.streams.jdk8.StreamsKt$$ExternalSyntheticLambda0
            ...
            public final Object get() {
                Spliterator m3759asStream$lambda4;
                m3759asStream$lambda4 = StreamsKt.m3759asStream$lambda4(Sequence.this);
                return m3759asStream$lambda4;
            }
        }, 16, false);
    ...
    public static final Spliterator m3759asStream$lambda4(Sequence this_asStream) {
