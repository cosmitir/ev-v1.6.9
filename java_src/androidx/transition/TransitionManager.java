...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition mo2351clone = transition.mo2351clone();
        mo2351clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            mo2351clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, mo2351clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, mo2351clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition mo2351clone = transition.mo2351clone();
        sceneChangeSetup(viewGroup, mo2351clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, mo2351clone);
    }
