...
public class TransitionSet extends Transition {
    ...
    public String toString(String str) {
        ...
        for (int i = 0; i < this.mTransitions.size(); i++) {
            transition = transition + ShellUtils.COMMAND_LINE_END + this.mTransitions.get(i).toString(str + "  ");
        }
        return transition;
    }
    ...
    @Override // androidx.transition.Transition
    /* renamed from: clone */
    public Transition mo2351clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo2351clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo2351clone());
        }
