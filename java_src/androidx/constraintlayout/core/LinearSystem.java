...
public class LinearSystem {
    ...
    */
    ...
    public void displayReadableRows() {
        displaySolverVariables();
        String str = " num vars " + this.mVariablesID + ShellUtils.COMMAND_LINE_END;
        for (int i = 0; i < this.mVariablesID + 1; i++) {
            SolverVariable solverVariable = this.mCache.mIndexedVariables[i];
            if (solverVariable != null && solverVariable.isFinalValue) {
                str = str + " $[" + i + "] => " + solverVariable + " = " + solverVariable.computedValue + ShellUtils.COMMAND_LINE_END;
            }
        }
        ...
        for (int i2 = 0; i2 < this.mVariablesID + 1; i2++) {
            ...
            if (solverVariable2 != null && solverVariable2.isSynonym) {
                str2 = str2 + " ~[" + i2 + "] => " + solverVariable2 + " = " + this.mCache.mIndexedVariables[solverVariable2.synonym] + " + " + solverVariable2.synonymDelta + ShellUtils.COMMAND_LINE_END;
            }
        }
        String str3 = str2 + "\n\n #  ";
        ...
        if (this.mGoal != null) {
            str3 = str3 + "Goal: " + this.mGoal + ShellUtils.COMMAND_LINE_END;
        }
