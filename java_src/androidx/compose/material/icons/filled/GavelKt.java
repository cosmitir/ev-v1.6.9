...
@Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, d2 = {"_gavel", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Gavel", "Landroidx/compose/material/icons/Icons$Filled;", "getGavel", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-extended-filled_release"}, k = 2, mv = {1, 6, 0}, xi = 48)
...
public final class GavelKt {
    ...
    public static final ImageVector getGavel(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.Gavel", Dp.m2105constructorimpl(24.0f), Dp.m2105constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, 96, null);
        int defaultFillType = VectorKt.getDefaultFillType();
        SolidColor solidColor = new SolidColor(Color.Companion.m372getBlack0d7_KjU(), null);
        int m616getButtKaPHkGw = StrokeCap.Companion.m616getButtKaPHkGw();
        int m626getBevelLxFBmk8 = StrokeJoin.Companion.m626getBevelLxFBmk8();
        PathBuilder pathBuilder = new PathBuilder();
        pathBuilder.moveTo(5.2496f, 8.0688f);
        pathBuilder.lineToRelative(2.83f, -2.8268f);
        ...
        pathBuilder2.moveTo(9.4857f, 3.8272f);
        pathBuilder2.lineToRelative(2.828f, -2.8288f);
        pathBuilder2.lineToRelative(5.6576f, 5.656f);
        pathBuilder2.lineToRelative(-2.828f, 2.8288f);
        pathBuilder2.close();
        ...
        pathBuilder3.moveTo(0.9989f, 12.3147f);
        pathBuilder3.lineToRelative(2.8284f, -2.8284f);
        pathBuilder3.lineToRelative(5.6568f, 5.6568f);
        pathBuilder3.lineToRelative(-2.8284f, 2.8284f);
        pathBuilder3.close();
