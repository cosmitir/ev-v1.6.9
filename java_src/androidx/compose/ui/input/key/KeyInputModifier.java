...
public final class KeyInputModifier implements Modifier.Element {
    ...
    public final boolean m1470processKeyInputZmokQxo(android.view.KeyEvent keyEvent) {
        ...
        if (modifiedKeyInputNode.m1721propagatePreviewKeyEventZmokQxo(keyEvent)) {
            return true;
        }
        return modifiedKeyInputNode.m1720propagateKeyEventZmokQxo(keyEvent);
    }
}
