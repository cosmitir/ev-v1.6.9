...
public final class KeyEvent_androidKt {
    ...
    public static final long m1463getKeyZmokQxo(android.view.KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "$this$<get-key>");
        return Key_androidKt.Key(keyEvent.getKeyCode());
    }

    /* renamed from: getUtf16CodePoint-ZmokQxo  reason: not valid java name */
    public static final int m1465getUtf16CodePointZmokQxo(android.view.KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "$this$<get-utf16CodePoint>");
        return keyEvent.getUnicodeChar();
    }

    /* renamed from: getType-ZmokQxo  reason: not valid java name */
    public static final int m1464getTypeZmokQxo(android.view.KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "$this$<get-type>");
        int action = keyEvent.getAction();
        if (action != 0) {
            if (action == 1) {
                return KeyEventType.Companion.m1461getKeyUpCS__XNY();
            }
            return KeyEventType.Companion.m1462getUnknownCS__XNY();
        }
        return KeyEventType.Companion.m1460getKeyDownCS__XNY();
    }

    /* renamed from: isAltPressed-ZmokQxo  reason: not valid java name */
    public static final boolean m1466isAltPressedZmokQxo(android.view.KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "$this$<get-isAltPressed>");
        return keyEvent.isAltPressed();
    }

    /* renamed from: isCtrlPressed-ZmokQxo  reason: not valid java name */
    public static final boolean m1467isCtrlPressedZmokQxo(android.view.KeyEvent keyEvent) {
    ...
    public static final boolean m1468isMetaPressedZmokQxo(android.view.KeyEvent keyEvent) {
        Intrinsics.checkNotNullParameter(keyEvent, "$this$<get-isMetaPressed>");
        return keyEvent.isMetaPressed();
    }

    /* renamed from: isShiftPressed-ZmokQxo  reason: not valid java name */
    public static final boolean m1469isShiftPressedZmokQxo(android.view.KeyEvent keyEvent) {
