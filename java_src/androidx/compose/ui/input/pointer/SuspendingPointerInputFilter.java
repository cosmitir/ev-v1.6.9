...
public final class SuspendingPointerInputFilter extends PointerInputFilter implements PointerInputModifier, PointerInputScope, Density {
    ...
    public SuspendingPointerInputFilter(ViewConfiguration viewConfiguration, Density density) {
        ...
        this.boundsSize = IntSize.Companion.m2230getZeroYbymL2g();
    }
    ...
    public void mo1539onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long j) {
        boolean z;
        ...
        if (size >= 0) {
            ...
            while (true) {
                ...
                if (pointerInputChange2.getPressed()) {
                    long m1523getPositionF1C5BW0 = pointerInputChange2.m1523getPositionF1C5BW0();
                    ...
                    pointerInputChange = pointerInputChange2.m1521copyEzrO64((r30 & 1) != 0 ? pointerInputChange2.m1522getIdJ3iCeTQ() : 0L, (r30 & 2) != 0 ? pointerInputChange2.uptimeMillis : 0L, (r30 & 4) != 0 ? pointerInputChange2.m1523getPositionF1C5BW0() : 0L, (r30 & 8) != 0 ? pointerInputChange2.pressed : false, (r30 & 16) != 0 ? pointerInputChange2.previousUptimeMillis : uptimeMillis, (r30 & 32) != 0 ? pointerInputChange2.m1524getPreviousPositionF1C5BW0() : m1523getPositionF1C5BW0, (r30 & 64) != 0 ? pointerInputChange2.previousPressed : pressed, (r30 & 128) != 0 ? pointerInputChange2.consumed : consumedData, (r30 & 256) != 0 ? pointerInputChange2.m1525getTypeT8wyACA() : 0);
                } else {
    ...
    public final class PointerEventHandlerCoroutine<R> implements AwaitPointerEventScope, Density, Continuation<R> {
        ...
        public long mo1495getSizeYbymL2g() {
        ...
        public final void offerPointerEvent(PointerEvent event, PointerEventPass pass) {
            ...
            cancellableContinuation.resumeWith(Result.m2465constructorimpl(event));
        }
    ...
    public <R> Object awaitPointerEventScope(Function2<? super AwaitPointerEventScope, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
        ...
        synchronized (this.pointerHandlers) {
            ...
            Unit unit = Unit.INSTANCE;
            Result.Companion companion = Result.Companion;
            createCoroutine.resumeWith(Result.m2465constructorimpl(unit));
