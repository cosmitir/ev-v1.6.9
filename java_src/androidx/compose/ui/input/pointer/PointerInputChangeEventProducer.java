...
final class PointerInputChangeEventProducer {
    ...
    public final InternalPointerEvent produce(PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator) {
        long uptime;
        boolean down;
        long mo1575screenToLocalMKHz9U;
        ...
        if (size >= 0) {
            ...
            while (true) {
                ...
                PointerInputData pointerInputData = this.previousPointerInputData.get(PointerId.m1513boximpl(pointerInputEventData.m1533getIdJ3iCeTQ()));
                if (pointerInputData == null) {
                    down = z;
                    uptime = pointerInputEventData.getUptime();
                    mo1575screenToLocalMKHz9U = pointerInputEventData.m1534getPositionF1C5BW0();
                } else {
                    uptime = pointerInputData.getUptime();
                    down = pointerInputData.getDown();
                    mo1575screenToLocalMKHz9U = positionCalculator.mo1575screenToLocalMKHz9U(pointerInputData.m1526getPositionOnScreenF1C5BW0());
                }
                linkedHashMap.put(PointerId.m1513boximpl(pointerInputEventData.m1533getIdJ3iCeTQ()), new PointerInputChange(pointerInputEventData.m1533getIdJ3iCeTQ(), pointerInputEventData.getUptime(), pointerInputEventData.m1534getPositionF1C5BW0(), pointerInputEventData.getDown(), uptime, mo1575screenToLocalMKHz9U, down, new ConsumedData(z, z, 3, null), pointerInputEventData.m1536getTypeT8wyACA(), null));
                if (pointerInputEventData.getDown()) {
                    this.previousPointerInputData.put(PointerId.m1513boximpl(pointerInputEventData.m1533getIdJ3iCeTQ()), new PointerInputData(pointerInputEventData.getUptime(), pointerInputEventData.m1535getPositionOnScreenF1C5BW0(), pointerInputEventData.getDown(), null));
                } else {
                    this.previousPointerInputData.remove(PointerId.m1513boximpl(pointerInputEventData.m1533getIdJ3iCeTQ()));
                }
                if (i2 > size) {
                    break;
                }
    ...
    private static final class PointerInputData {
        ...
        public final long m1526getPositionOnScreenF1C5BW0() {
