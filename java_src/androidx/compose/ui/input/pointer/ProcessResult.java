...
public final class ProcessResult {
    ...
    public static final /* synthetic */ ProcessResult m1576boximpl(int i) {
    ...
    public static boolean m1578equalsimpl(int i, Object obj) {
        return (obj instanceof ProcessResult) && i == ((ProcessResult) obj).m1584unboximpl();
    }
    ...
    public static final boolean m1580getAnyMovementConsumedimpl(int i) {
        return (i & 2) != 0;
    }

    /* renamed from: getDispatchedToAPointerInputModifier-impl  reason: not valid java name */
    public static final boolean m1581getDispatchedToAPointerInputModifierimpl(int i) {
        return (i & 1) != 0;
    }
    ...
    public boolean equals(Object obj) {
        return m1578equalsimpl(m1584unboximpl(), obj);
    }

    public int hashCode() {
        return m1582hashCodeimpl(m1584unboximpl());
    }

    public String toString() {
        return m1583toStringimpl(m1584unboximpl());
    }
