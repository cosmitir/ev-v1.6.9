...
final class VelocityEstimate {
    ...
    private static final VelocityEstimate None = new VelocityEstimate(Offset.Companion.m133getZeroF1C5BW0(), 1.0f, 0, Offset.Companion.m133getZeroF1C5BW0(), null);
    ...
    public final long m1590component1F1C5BW0() {
    ...
    public final long m1591component4F1C5BW0() {
        return this.offset;
    }

    /* renamed from: copy-PZAlG8E  reason: not valid java name */
    public final VelocityEstimate m1592copyPZAlG8E(long j, float f, long j2, long j3) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VelocityEstimate) {
            ...
            return Offset.m114equalsimpl0(this.pixelsPerSecond, velocityEstimate.pixelsPerSecond) && Intrinsics.areEqual((Object) Float.valueOf(this.confidence), (Object) Float.valueOf(velocityEstimate.confidence)) && this.durationMillis == velocityEstimate.durationMillis && Offset.m114equalsimpl0(this.offset, velocityEstimate.offset);
        }
        return false;
    }

    public int hashCode() {
        return (((((Offset.m119hashCodeimpl(this.pixelsPerSecond) * 31) + Float.hashCode(this.confidence)) * 31) + Long.hashCode(this.durationMillis)) * 31) + Offset.m119hashCodeimpl(this.offset);
    }

    public String toString() {
        return "VelocityEstimate(pixelsPerSecond=" + ((Object) Offset.m125toStringimpl(this.pixelsPerSecond)) + ", confidence=" + this.confidence + ", durationMillis=" + this.durationMillis + ", offset=" + ((Object) Offset.m125toStringimpl(this.offset)) + ')';
    }
    ...
    public final long m1594getPixelsPerSecondF1C5BW0() {
        return this.pixelsPerSecond;
    }
    ...
    public final long m1593getOffsetF1C5BW0() {
        return this.offset;
    }
