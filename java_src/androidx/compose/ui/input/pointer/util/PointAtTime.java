...
final class PointAtTime {
    ...
    public static /* synthetic */ PointAtTime m1585copy3MmeM6k$default(PointAtTime pointAtTime, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
            j = pointAtTime.point;
        }
        if ((i & 2) != 0) {
        ...
        return pointAtTime.m1587copy3MmeM6k(j, j2);
    }

    /* renamed from: component1-F1C5BW0  reason: not valid java name */
    public final long m1586component1F1C5BW0() {
        return this.point;
    }
    ...
    public final PointAtTime m1587copy3MmeM6k(long j, long j2) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PointAtTime) {
            ...
            return Offset.m114equalsimpl0(this.point, pointAtTime.point) && this.time == pointAtTime.time;
        }
        return false;
    }

    public int hashCode() {
        return (Offset.m119hashCodeimpl(this.point) * 31) + Long.hashCode(this.time);
    }

    public String toString() {
        return "PointAtTime(point=" + ((Object) Offset.m125toStringimpl(this.point)) + ", time=" + this.time + ')';
    }
    ...
    public final long m1588getPointF1C5BW0() {
        return this.point;
    }
