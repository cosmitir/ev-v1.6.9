...
public final class PointerEventKt {
    ...
    public static final boolean positionChanged(PointerInputChange pointerInputChange) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "<this>");
        return !Offset.m114equalsimpl0(positionChangeInternal(pointerInputChange, false), Offset.Companion.m133getZeroF1C5BW0());
    }

    public static final boolean positionChangedIgnoreConsumed(PointerInputChange pointerInputChange) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "<this>");
        return !Offset.m114equalsimpl0(positionChangeInternal(pointerInputChange, true), Offset.Companion.m133getZeroF1C5BW0());
    }
    ...
    private static final long positionChangeInternal(PointerInputChange pointerInputChange, boolean z) {
        long m121minusMKHz9U = Offset.m121minusMKHz9U(pointerInputChange.m1523getPositionF1C5BW0(), pointerInputChange.m1524getPreviousPositionF1C5BW0());
        return (z || !pointerInputChange.getConsumed().getPositionChange()) ? m121minusMKHz9U : Offset.Companion.m133getZeroF1C5BW0();
    }
    ...
    public static final void consumePositionChange(PointerInputChange pointerInputChange) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "<this>");
        if (Offset.m114equalsimpl0(positionChange(pointerInputChange), Offset.Companion.m133getZeroF1C5BW0())) {
            return;
        }
    ...
    public static final boolean m1512isOutOfBoundsO0kMr_c(PointerInputChange isOutOfBounds, long j) {
        Intrinsics.checkNotNullParameter(isOutOfBounds, "$this$isOutOfBounds");
        long m1523getPositionF1C5BW0 = isOutOfBounds.m1523getPositionF1C5BW0();
        float m117getXimpl = Offset.m117getXimpl(m1523getPositionF1C5BW0);
        float m118getYimpl = Offset.m118getYimpl(m1523getPositionF1C5BW0);
        return m117getXimpl < 0.0f || m117getXimpl > ((float) IntSize.m2225getWidthimpl(j)) || m118getYimpl < 0.0f || m118getYimpl > ((float) IntSize.m2224getHeightimpl(j));
    }
}
