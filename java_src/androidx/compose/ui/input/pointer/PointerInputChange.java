...
public final class PointerInputChange {
    ...
    public final long m1522getIdJ3iCeTQ() {
        return this.id;
    }
    ...
    public final long m1523getPositionF1C5BW0() {
    ...
    public final long m1524getPreviousPositionF1C5BW0() {
    ...
    public /* synthetic */ PointerInputChange(long j, long j2, long j3, boolean z, long j4, long j5, boolean z2, ConsumedData consumedData, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, j2, j3, z, j4, j5, z2, consumedData, (i2 & 256) != 0 ? PointerType.Companion.m1572getTouchT8wyACA() : i, null);
    }

    /* renamed from: getType-T8wyACA  reason: not valid java name */
    public final int m1525getTypeT8wyACA() {
        return this.type;
    }

    /* renamed from: copy-Ezr-O64  reason: not valid java name */
    public final PointerInputChange m1521copyEzrO64(long j, long j2, long j3, boolean z, long j4, long j5, boolean z2, ConsumedData consumed, int i) {
        Intrinsics.checkNotNullParameter(consumed, "consumed");
        return new PointerInputChange(j, j2, j3, z, j4, j5, z2, consumed, i, null);
    }

    public String toString() {
        return "PointerInputChange(id=" + ((Object) PointerId.m1518toStringimpl(m1522getIdJ3iCeTQ())) + ", uptimeMillis=" + this.uptimeMillis + ", position=" + ((Object) Offset.m125toStringimpl(m1523getPositionF1C5BW0())) + ", pressed=" + this.pressed + ", previousUptimeMillis=" + this.previousUptimeMillis + ", previousPosition=" + ((Object) Offset.m125toStringimpl(m1524getPreviousPositionF1C5BW0())) + ", previousPressed=" + this.previousPressed + ", consumed=" + this.consumed + ", type=" + ((Object) PointerType.m1567toStringimpl(m1525getTypeT8wyACA())) + ')';
    }
}
