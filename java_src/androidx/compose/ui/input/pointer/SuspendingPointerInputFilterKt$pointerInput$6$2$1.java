...
public final class SuspendingPointerInputFilterKt$pointerInput$6$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public SuspendingPointerInputFilterKt$pointerInput$6$2$1(Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object> function2, SuspendingPointerInputFilter suspendingPointerInputFilter, Continuation<? super SuspendingPointerInputFilterKt$pointerInput$6$2$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new SuspendingPointerInputFilterKt$pointerInput$6$2$1(this.$block, this.$this_apply, continuation);
    }
