                ...
                if (nestedScrollConnection != null) {
                    ...
                    function0 = new Function0<CoroutineScope>() { // from class: androidx.compose.ui.input.nestedscroll.NestedScrollDelegatingWrapper$refreshChildrenWithParentConnection$1$2
                        ...
                        public final CoroutineScope invoke() {
                            ...
                            NestedScrollModifier modifier = nestedScrollDelegatingWrapper3 == null ? null : nestedScrollDelegatingWrapper3.getModifier();
                            if (modifier == null || (dispatcher = modifier.getDispatcher()) == null) {
                                return null;
                            }
