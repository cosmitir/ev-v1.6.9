...
public final class NestedScrollSource {
    ...
    private static final int Drag = m1485constructorimpl(1);
    private static final int Fling = m1485constructorimpl(2);
    private static final int Relocate = m1485constructorimpl(3);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ NestedScrollSource m1484boximpl(int i) {
    ...
    public static boolean m1486equalsimpl(int i, Object obj) {
        return (obj instanceof NestedScrollSource) && i == ((NestedScrollSource) obj).m1490unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m1486equalsimpl(m1490unboximpl(), obj);
    }

    public int hashCode() {
        return m1488hashCodeimpl(m1490unboximpl());
    }
    ...
    public String toString() {
        return m1489toStringimpl(m1490unboximpl());
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1489toStringimpl(int i) {
        return m1487equalsimpl0(i, Drag) ? "Drag" : m1487equalsimpl0(i, Fling) ? "Fling" : m1487equalsimpl0(i, Relocate) ? "Relocate" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m1491getRelocateWNlRxjI$annotations() {
        }
        ...
        public final int m1492getDragWNlRxjI() {
            return NestedScrollSource.Drag;
        }

        /* renamed from: getFling-WNlRxjI  reason: not valid java name */
        public final int m1493getFlingWNlRxjI() {
            return NestedScrollSource.Fling;
        }

        /* renamed from: getRelocate-WNlRxjI  reason: not valid java name */
        public final int m1494getRelocateWNlRxjI() {
