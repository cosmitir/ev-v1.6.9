...
public final class SemanticsNode {
    ...
    public final long m1780getSizeYbymL2g() {
        return findWrapperToGetBounds().mo1619getSizeYbymL2g();
    }
    ...
    public final long m1778getPositionInRootF1C5BW0() {
        return !this.layoutNode.isAttached() ? Offset.Companion.m133getZeroF1C5BW0() : LayoutCoordinatesKt.positionInRoot(findWrapperToGetBounds());
    }
    ...
    public final long m1779getPositionInWindowF1C5BW0() {
        return !this.layoutNode.isAttached() ? Offset.Companion.m133getZeroF1C5BW0() : LayoutCoordinatesKt.positionInWindow(findWrapperToGetBounds());
    }
    ...
    private final List<SemanticsNode> getChildren(boolean z, boolean z2) {
        ...
        return unmergedChildren$ui_release(z);
    }
    ...
    private final void emitFakeNodes(List<SemanticsNode> list) {
        ...
        if (role != null && this.unmergedConfig.isMergingSemanticsOfDescendants() && (!list.isEmpty())) {
            list.add(m1777fakeSemanticsNodeypyhhiA(role, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.ui.semantics.SemanticsNode$emitFakeNodes$fakeNode$1
                ...
                public final void invoke2(SemanticsPropertyReceiver fakeSemanticsNode) {
                    ...
                    SemanticsPropertiesKt.m1784setRolekuIjeqM(fakeSemanticsNode, Role.this.m1770unboximpl());
                }
            }));
        }
        if (this.unmergedConfig.contains(SemanticsProperties.INSTANCE.getContentDescription()) && (!list.isEmpty()) && this.unmergedConfig.isMergingSemanticsOfDescendants()) {
            ...
            final String str = list2 == null ? null : (String) CollectionsKt.firstOrNull((List<? extends Object>) list2);
            if (str != null) {
                list.add(0, m1777fakeSemanticsNodeypyhhiA(null, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.ui.semantics.SemanticsNode$emitFakeNodes$fakeNode$2
                    /* JADX INFO: Access modifiers changed from: package-private */
    ...
    private final SemanticsNode m1777fakeSemanticsNodeypyhhiA(Role role, Function1<? super SemanticsPropertyReceiver, Unit> function1) {
