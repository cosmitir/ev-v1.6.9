...
public final class ShadowKt {
    ...
    public static /* synthetic */ Modifier m57shadowziNgDLE$default(Modifier modifier, float f, Shape shape, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        if ((i & 4) != 0) {
            z = false;
            if (Dp.m2104compareTo0680j_4(f, Dp.m2105constructorimpl(0)) > 0) {
                z = true;
            }
        }
        return m56shadowziNgDLE(modifier, f, shape, z);
    }

    /* renamed from: shadow-ziNgDLE  reason: not valid java name */
    public static final Modifier m56shadowziNgDLE(Modifier shadow, final float f, final Shape shape, final boolean z) {
        Intrinsics.checkNotNullParameter(shadow, "$this$shadow");
        Intrinsics.checkNotNullParameter(shape, "shape");
        if (Dp.m2104compareTo0680j_4(f, Dp.m2105constructorimpl(0)) > 0 || z) {
            return ComposedModifierKt.composed(shadow, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.ui.draw.ShadowKt$shadow-ziNgDLE$$inlined$debugInspectorInfo$1
                ...
                public final void invoke2(InspectorInfo inspectorInfo) {
                    ...
                    inspectorInfo.getProperties().set("elevation", Dp.m2103boximpl(f));
                ...
                public final Modifier invoke(Modifier composed, Composer composer, int i) {
                    ...
                    Modifier graphicsLayer = GraphicsLayerModifierKt.graphicsLayer(composed, new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.ui.draw.ShadowKt$shadow$2.1
                        ...
                        public final void invoke2(GraphicsLayerScope graphicsLayer2) {
                            ...
                            graphicsLayer2.setShadowElevation(graphicsLayer2.mo48toPx0680j_4(f2));
