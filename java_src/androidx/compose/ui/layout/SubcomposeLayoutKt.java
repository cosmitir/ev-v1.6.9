...
public final class SubcomposeLayoutKt {
    ...
    public static final void SubcomposeLayout(final SubcomposeLayoutState state, Modifier modifier, final Function2<? super SubcomposeMeasureScope, ? super Constraints, ? extends MeasureResult> measurePolicy, Composer composer, final int i, final int i2) {
        ...
        Updater.m25initimpl(m21constructorimpl, state.getSetRoot$ui_release());
        Updater.m28setimpl(m21constructorimpl, materialize, ComposeUiNode.Companion.getSetModifier());
        Updater.m28setimpl(m21constructorimpl, measurePolicy, state.getSetMeasurePolicy$ui_release());
