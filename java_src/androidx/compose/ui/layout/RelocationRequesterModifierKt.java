...
public final class RelocationRequesterModifierKt {
    ...
    public static final void bringIntoView(NestedScrollDelegatingWrapper nestedScrollDelegatingWrapper, LayoutCoordinates layoutCoordinates) {
        ...
        nestedScrollDelegatingWrapper.getModifier().getConnection().mo1473onPostScrollDzOQY0M(Offset.Companion.m133getZeroF1C5BW0(), OffsetKt.Offset(calculateOffset(localBoundingBoxOf.getLeft(), localBoundingBoxOf.getRight(), IntSize.m2225getWidthimpl(nestedScrollDelegatingWrapper.mo1619getSizeYbymL2g())), calculateOffset(localBoundingBoxOf.getTop(), localBoundingBoxOf.getBottom(), IntSize.m2224getHeightimpl(nestedScrollDelegatingWrapper.mo1619getSizeYbymL2g()))), NestedScrollSource.Companion.m1494getRelocateWNlRxjI());
