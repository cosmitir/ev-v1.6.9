    ...
    public AndroidViewHolder(Context context, CompositionContext compositionContext) {
        ...
        layoutNode.setMeasurePolicy(new MeasurePolicy() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5
            ...
            public MeasureResult mo1624measure3p2s80s(MeasureScope receiver, List<? extends Measurable> measurables, long j) {
                ...
                if (Constraints.m2077getMinWidthimpl(j) != 0) {
                    AndroidViewHolder.this.getChildAt(0).setMinimumWidth(Constraints.m2077getMinWidthimpl(j));
                }
                if (Constraints.m2076getMinHeightimpl(j) != 0) {
                    AndroidViewHolder.this.getChildAt(0).setMinimumHeight(Constraints.m2076getMinHeightimpl(j));
                }
                AndroidViewHolder androidViewHolder = AndroidViewHolder.this;
                ...
                obtainMeasureSpec = androidViewHolder.obtainMeasureSpec(m2077getMinWidthimpl, m2075getMaxWidthimpl, layoutParams.width);
                ...
                obtainMeasureSpec2 = androidViewHolder2.obtainMeasureSpec(m2076getMinHeightimpl, m2074getMaxHeightimpl, layoutParams2.height);
