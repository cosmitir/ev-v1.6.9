...
public final class IntRectKt {
    ...
    public static final IntRect m2215IntRectVbeCjmY(long j, long j2) {
        return new IntRect(IntOffset.m2183getXimpl(j), IntOffset.m2184getYimpl(j), IntOffset.m2183getXimpl(j) + IntSize.m2225getWidthimpl(j2), IntOffset.m2184getYimpl(j) + IntSize.m2224getHeightimpl(j2));
    }

    /* renamed from: IntRect-E1MhUcY  reason: not valid java name */
    public static final IntRect m2214IntRectE1MhUcY(long j, long j2) {
        return new IntRect(IntOffset.m2183getXimpl(j), IntOffset.m2184getYimpl(j), IntOffset.m2183getXimpl(j2), IntOffset.m2184getYimpl(j2));
    }

    /* renamed from: IntRect-ar5cAso  reason: not valid java name */
    public static final IntRect m2216IntRectar5cAso(long j, int i) {
        return new IntRect(IntOffset.m2183getXimpl(j) - i, IntOffset.m2184getYimpl(j) - i, IntOffset.m2183getXimpl(j) + i, IntOffset.m2184getYimpl(j) + i);
    }
