...
public final class FocusRequesterModifierImpl extends InspectorValueInfo implements FocusRequesterModifier {
    ...
    public <R> R foldIn(R r, Function2<? super R, ? super Modifier.Element, ? extends R> function2) {
        return (R) FocusRequesterModifier.DefaultImpls.foldIn(this, r, function2);
    }

    @Override // androidx.compose.ui.Modifier.Element, androidx.compose.ui.Modifier
    public <R> R foldOut(R r, Function2<? super Modifier.Element, ? super R, ? extends R> function2) {
        return (R) FocusRequesterModifier.DefaultImpls.foldOut(this, r, function2);
    }
    ...
    public FocusRequesterModifierImpl(FocusRequester focusRequester, Function1<? super InspectorInfo, Unit> inspectorInfo) {
        super(inspectorInfo);
