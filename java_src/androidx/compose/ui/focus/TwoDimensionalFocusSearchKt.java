...
public final class TwoDimensionalFocusSearchKt {
    ...
    public static final ModifiedFocusNode m82twoDimensionalFocusSearchMxy_nc0(ModifiedFocusNode twoDimensionalFocusSearch, int i) {
        ModifiedFocusNode m82twoDimensionalFocusSearchMxy_nc0;
        Rect bottomRight;
        ...
        if (i2 != 1) {
            if (i2 != 2) {
                if (i2 == 3) {
                    ...
                    if (focusedChild.getFocusState() != FocusStateImpl.ActiveParent || (m82twoDimensionalFocusSearchMxy_nc0 = m82twoDimensionalFocusSearchMxy_nc0(focusedChild, i)) == null) {
                        ...
                        return m80findBestCandidate4WY_MpI(twoDimensionalFocusSearch.focusableChildren(), focusRect, i);
                    }
                    return m82twoDimensionalFocusSearchMxy_nc0;
                } else if (i2 == 4 || i2 == 5) {
                    List<ModifiedFocusNode> focusableChildren = twoDimensionalFocusSearch.focusableChildren();
                    if (focusableChildren.size() <= 1) {
                        return (ModifiedFocusNode) CollectionsKt.firstOrNull((List<? extends Object>) focusableChildren);
                    }
                    if (FocusDirection.m61equalsimpl0(i, FocusDirection.Companion.m73getRightdhqQ8s()) ? true : FocusDirection.m61equalsimpl0(i, FocusDirection.Companion.m67getDowndhqQ8s())) {
                        bottomRight = topLeft(twoDimensionalFocusSearch.focusRect());
                    } else {
                        if (!(FocusDirection.m61equalsimpl0(i, FocusDirection.Companion.m69getLeftdhqQ8s()) ? true : FocusDirection.m61equalsimpl0(i, FocusDirection.Companion.m74getUpdhqQ8s()))) {
                            throw new IllegalStateException(invalidFocusDirection.toString());
                        }
                        bottomRight = bottomRight(twoDimensionalFocusSearch.focusRect());
                    }
                    return m80findBestCandidate4WY_MpI(focusableChildren, bottomRight, i);
                } else {
    ...
    private static final ModifiedFocusNode m80findBestCandidate4WY_MpI(List<ModifiedFocusNode> list, Rect rect, int i) {
        Rect translate;
        if (FocusDirection.m61equalsimpl0(i, FocusDirection.Companion.m69getLeftdhqQ8s())) {
            ...
            translate = rect.translate(-(rect.getWidth() + 1), 0.0f);
        } else if (FocusDirection.m61equalsimpl0(i, FocusDirection.Companion.m74getUpdhqQ8s())) {
            translate = rect.translate(0.0f, rect.getHeight() + 1);
        } else if (!FocusDirection.m61equalsimpl0(i, FocusDirection.Companion.m67getDowndhqQ8s())) {
            throw new IllegalStateException(invalidFocusDirection.toString());
        } else {
            translate = rect.translate(0.0f, -(rect.getHeight() + 1));
        }
        ...
        if (size >= 0) {
            ...
            while (true) {
                ...
                if (m81isBetterCandidateI7lrPNg(focusRect, translate, rect, i)) {
    ...
    private static final float isBetterCandidate_I7lrPNg$majorAxisDistance(Rect rect, int i, Rect rect2) {
        ...
        float f;
        if (!FocusDirection.m61equalsimpl0(i, FocusDirection.Companion.m69getLeftdhqQ8s())) {
            if (FocusDirection.m61equalsimpl0(i, FocusDirection.Companion.m73getRightdhqQ8s())) {
                top = rect.getLeft();
    ...
    private static final float isBetterCandidate_I7lrPNg$minorAxisDistance(Rect rect, int i, Rect rect2) {
        ...
        float left2;
        float width;
        if (FocusDirection.m61equalsimpl0(i, FocusDirection.Companion.m69getLeftdhqQ8s()) ? true : FocusDirection.m61equalsimpl0(i, FocusDirection.Companion.m73getRightdhqQ8s())) {
            f = 2;
            left = rect2.getTop() + (rect2.getHeight() / f);
            left2 = rect.getTop();
            width = rect.getHeight();
        } else {
            if (!(FocusDirection.m61equalsimpl0(i, FocusDirection.Companion.m74getUpdhqQ8s()) ? true : FocusDirection.m61equalsimpl0(i, FocusDirection.Companion.m67getDowndhqQ8s()))) {
                throw new IllegalStateException(invalidFocusDirection.toString());
            }
            f = 2;
    ...
    private static final boolean m81isBetterCandidateI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i) {
        if (isBetterCandidate_I7lrPNg$isCandidate(rect, i, rect3)) {
            return !isBetterCandidate_I7lrPNg$isCandidate(rect2, i, rect3) || m78beamBeatsI7lrPNg(rect3, rect, rect2, i) || (!m78beamBeatsI7lrPNg(rect3, rect2, rect, i) && isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect) < isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect2));
        }
        return false;
    }
    ...
    private static final float m79beamBeats_I7lrPNg$majorAxisDistance2(Rect rect, int i, Rect rect2) {
        float top;
        float bottom;
        float top2;
        float bottom2;
    ...
    private static final boolean m78beamBeatsI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i) {
        if (beamBeats_I7lrPNg$inSourceBeam(rect3, i, rect) || !beamBeats_I7lrPNg$inSourceBeam(rect2, i, rect)) {
            return false;
        }
        return !beamBeats_I7lrPNg$isInDirectionOfSearch(rect3, i, rect) || FocusDirection.m61equalsimpl0(i, FocusDirection.Companion.m69getLeftdhqQ8s()) || FocusDirection.m61equalsimpl0(i, FocusDirection.Companion.m73getRightdhqQ8s()) || m79beamBeats_I7lrPNg$majorAxisDistance2(rect2, i, rect) < beamBeats_I7lrPNg$majorAxisDistanceToFarEdge(rect3, i, rect);
    }
