...
public final class ParagraphInfo {
    ...
    public final long m1796toLocalMKHz9U(long j) {
        return OffsetKt.Offset(Offset.m117getXimpl(j), Offset.m118getYimpl(j) - this.top);
    }

    public final Rect toGlobal(Rect rect) {
        Intrinsics.checkNotNullParameter(rect, "<this>");
        return rect.m154translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    public final Path toGlobal(Path path) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        path.mo253translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return path;
    }

    /* renamed from: toGlobal-GEjPoXI  reason: not valid java name */
    public final long m1795toGlobalGEjPoXI(long j) {
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m1864getStartimpl(j)), toGlobalIndex(TextRange.m1859getEndimpl(j)));
    }
}
