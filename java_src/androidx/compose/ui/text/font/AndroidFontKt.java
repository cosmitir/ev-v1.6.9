...
public final class AndroidFontKt {
    ...
    public static /* synthetic */ Font m1891FontwCLgNak$default(AssetManager assetManager, String str, FontWeight fontWeight, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
        ...
        return m1890FontwCLgNak(assetManager, str, fontWeight, i);
    }

    @ExperimentalTextApi
    /* renamed from: Font-wCLgNak  reason: not valid java name */
    public static final Font m1890FontwCLgNak(AssetManager assetManager, String path, FontWeight weight, int i) {
    ...
    public static /* synthetic */ Font m1889FontRetOiIg$default(File file, FontWeight fontWeight, int i, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            fontWeight = FontWeight.Companion.getNormal();
        }
        if ((i2 & 4) != 0) {
        ...
        return m1887FontRetOiIg(file, fontWeight, i);
    }

    @ExperimentalTextApi
    /* renamed from: Font-RetOiIg  reason: not valid java name */
    public static final Font m1887FontRetOiIg(File file, FontWeight weight, int i) {
    ...
    /* renamed from: Font-RetOiIg$default  reason: not valid java name */
    public static /* synthetic */ Font m1888FontRetOiIg$default(ParcelFileDescriptor parcelFileDescriptor, FontWeight fontWeight, int i, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            fontWeight = FontWeight.Companion.getNormal();
        }
        if ((i2 & 4) != 0) {
        ...
        return m1886FontRetOiIg(parcelFileDescriptor, fontWeight, i);
    }

    @ExperimentalTextApi
    /* renamed from: Font-RetOiIg  reason: not valid java name */
    public static final Font m1886FontRetOiIg(ParcelFileDescriptor fileDescriptor, FontWeight weight, int i) {
