...
public final class TextLayoutInput {
    ...
    public final int m1844getOverflowgIe3tQ8() {
    ...
    public final long m1843getConstraintsmsEJaDk() {
        return this.constraints;
    }

    /* renamed from: copy-hu-1Yfo  reason: not valid java name */
    public final TextLayoutInput m1842copyhu1Yfo(AnnotatedString text, TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int i, boolean z, int i2, Density density, LayoutDirection layoutDirection, Font.ResourceLoader resourceLoader, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TextLayoutInput) {
            ...
            return Intrinsics.areEqual(this.text, textLayoutInput.text) && Intrinsics.areEqual(this.style, textLayoutInput.style) && Intrinsics.areEqual(this.placeholders, textLayoutInput.placeholders) && this.maxLines == textLayoutInput.maxLines && this.softWrap == textLayoutInput.softWrap && TextOverflow.m2056equalsimpl0(m1844getOverflowgIe3tQ8(), textLayoutInput.m1844getOverflowgIe3tQ8()) && Intrinsics.areEqual(this.density, textLayoutInput.density) && this.layoutDirection == textLayoutInput.layoutDirection && Intrinsics.areEqual(this.resourceLoader, textLayoutInput.resourceLoader) && Constraints.m2068equalsimpl0(m1843getConstraintsmsEJaDk(), textLayoutInput.m1843getConstraintsmsEJaDk());
        }
        return false;
    }

    public int hashCode() {
        return (((((((((((((((((this.text.hashCode() * 31) + this.style.hashCode()) * 31) + this.placeholders.hashCode()) * 31) + this.maxLines) * 31) + Boolean.hashCode(this.softWrap)) * 31) + TextOverflow.m2057hashCodeimpl(m1844getOverflowgIe3tQ8())) * 31) + this.density.hashCode()) * 31) + this.layoutDirection.hashCode()) * 31) + this.resourceLoader.hashCode()) * 31) + Constraints.m2078hashCodeimpl(m1843getConstraintsmsEJaDk());
    }

    public String toString() {
        return "TextLayoutInput(text=" + ((Object) this.text) + ", style=" + this.style + ", placeholders=" + this.placeholders + ", maxLines=" + this.maxLines + ", softWrap=" + this.softWrap + ", overflow=" + ((Object) TextOverflow.m2058toStringimpl(m1844getOverflowgIe3tQ8())) + ", density=" + this.density + ", layoutDirection=" + this.layoutDirection + ", resourceLoader=" + this.resourceLoader + ", constraints=" + ((Object) Constraints.m2080toStringimpl(m1843getConstraintsmsEJaDk())) + ')';
    }
}
