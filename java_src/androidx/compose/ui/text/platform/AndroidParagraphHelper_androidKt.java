...
public final class AndroidParagraphHelper_androidKt {
    public static final CharSequence createCharSequence(String text, float f, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> spanStyles, List<AnnotatedString.Range<Placeholder>> placeholders, Density density, TypefaceAdapter typefaceAdapter) {
        ...
        if (spanStyles.isEmpty() && placeholders.isEmpty() && Intrinsics.areEqual(contextTextStyle.getTextIndent(), TextIndent.Companion.getNone()) && TextUnitKt.m2264isUnspecifiedR2X_6o(contextTextStyle.m1881getLineHeightXSAIIZE())) {
            return text;
        }
        SpannableString spannableString = new SpannableString(text);
        SpannableString spannableString2 = spannableString;
        SpannableExtensions_androidKt.m2009setLineHeightr9BaKPg(spannableString2, contextTextStyle.m1881getLineHeightXSAIIZE(), f, density);
