...
public final class AndroidParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    public AndroidParagraphIntrinsics(String text, TextStyle style, List<AnnotatedString.Range<SpanStyle>> spanStyles, List<AnnotatedString.Range<Placeholder>> placeholders, TypefaceAdapter typefaceAdapter, Density density) {
        ...
        int m1981resolveTextDirectionHeuristics9GRLPo0 = AndroidParagraphIntrinsics_androidKt.m1981resolveTextDirectionHeuristics9GRLPo0(style.m1883getTextDirectionmmuk1to(), style.getLocaleList());
        this.textDirectionHeuristic = m1981resolveTextDirectionHeuristics9GRLPo0;
        ...
        this.layoutIntrinsics = new LayoutIntrinsics(createCharSequence, androidTextPaint, m1981resolveTextDirectionHeuristics9GRLPo0);
    }
