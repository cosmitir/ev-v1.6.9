...
public final class AndroidGenericFontFamilyTypeface implements AndroidTypeface {
    ...
    public Typeface mo1978getNativeTypefacePYhJU0U(FontWeight fontWeight, int i, int i2) {
        ...
        return m1980getOrPutFO1MlWM(fontWeight, i);
    }

    /* renamed from: getOrPut-FO1MlWM  reason: not valid java name */
    public final Typeface m1980getOrPutFO1MlWM(FontWeight fontWeight, int i) {
        Typeface typeface;
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        int weight = (fontWeight.getWeight() << 1) | (FontStyle.m1900equalsimpl0(i, FontStyle.Companion.m1904getItalic_LCdwA()) ? 1 : 0);
        synchronized (this.lock) {
            typeface = this.styledCache.get(weight);
            if (typeface == null) {
                typeface = m1979buildStyledTypefaceFO1MlWM(fontWeight, i);
    ...
    private final Typeface m1979buildStyledTypefaceFO1MlWM(FontWeight fontWeight, int i) {
        if (Build.VERSION.SDK_INT < 28) {
            return Typeface.create(this.nativeTypeface, TypefaceAdapter.Companion.m1998getTypefaceStyleFO1MlWM(fontWeight, i));
        }
        return TypefaceAdapterHelperMethods.INSTANCE.create(this.nativeTypeface, fontWeight.getWeight(), FontStyle.m1900equalsimpl0(i, FontStyle.Companion.m1904getItalic_LCdwA()));
    }
}
