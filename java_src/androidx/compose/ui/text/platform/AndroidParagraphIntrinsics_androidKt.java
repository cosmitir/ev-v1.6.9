...
public final class AndroidParagraphIntrinsics_androidKt {
    ...
    public static /* synthetic */ int m1982resolveTextDirectionHeuristics9GRLPo0$default(TextDirection textDirection, LocaleList localeList, int i, Object obj) {
        if ((i & 1) != 0) {
            textDirection = null;
        }
        if ((i & 2) != 0) {
        ...
        return m1981resolveTextDirectionHeuristics9GRLPo0(textDirection, localeList);
    }

    /* renamed from: resolveTextDirectionHeuristics-9GRLPo0  reason: not valid java name */
    public static final int m1981resolveTextDirectionHeuristics9GRLPo0(TextDirection textDirection, LocaleList localeList) {
        int m2044getContents_7Xco = textDirection == null ? TextDirection.Companion.m2044getContents_7Xco() : textDirection.m2043unboximpl();
        if (TextDirection.m2040equalsimpl0(m2044getContents_7Xco, TextDirection.Companion.m2045getContentOrLtrs_7Xco())) {
            return 2;
        }
        if (!TextDirection.m2040equalsimpl0(m2044getContents_7Xco, TextDirection.Companion.m2046getContentOrRtls_7Xco())) {
            if (TextDirection.m2040equalsimpl0(m2044getContents_7Xco, TextDirection.Companion.m2047getLtrs_7Xco())) {
                return 0;
            }
            if (TextDirection.m2040equalsimpl0(m2044getContents_7Xco, TextDirection.Companion.m2048getRtls_7Xco())) {
                return 1;
            }
            if (TextDirection.m2040equalsimpl0(m2044getContents_7Xco, TextDirection.Companion.m2044getContents_7Xco())) {
