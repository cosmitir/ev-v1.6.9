...
@Metadata(d1 = {"\u0000,\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0000\u001a0\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0012\u0010\u0003\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00020\u00050\u00042\f\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\b0\u0007H\u0002\u001a,\u0010\t\u001a\u00020\n*\u00020\n2\u001e\u0010\t\u001a\u001a\u0012\u0004\u0012\u00020\f\u0012\u0004\u0012\u00020\b\u0012\u0004\u0012\u00020\b\u0012\u0004\u0012\u00020\f0\u000bH\u0000¨\u0006\r"}, d2 = {"collectRangeTransitions", "", "T", "ranges", "", "Landroidx/compose/ui/text/AnnotatedString$Range;", TypedValues.AttributesType.S_TARGET, "Ljava/util/SortedSet;", "", "transform", "Landroidx/compose/ui/text/AnnotatedString;", "Lkotlin/Function3;", "", "ui-text_release"}, k = 2, mv = {1, 5, 1}, xi = 48)
    ...
    public static final AnnotatedString transform(final AnnotatedString annotatedString, final Function3<? super String, ? super Integer, ? super Integer, String> transform) {
        ...
        if (size >= 0) {
            ...
            while (true) {
                ...
                Integer num = (Integer) mutableMapOf.get(Integer.valueOf(range.getStart()));
                Intrinsics.checkNotNull(num);
                int intValue = num.intValue();
                Integer num2 = (Integer) mutableMapOf.get(Integer.valueOf(range.getEnd()));
        ...
        if (size2 >= 0) {
            ...
            while (true) {
                ...
                Integer num3 = (Integer) mutableMapOf.get(Integer.valueOf(range2.getStart()));
                Intrinsics.checkNotNull(num3);
                int intValue2 = num3.intValue();
                Integer num4 = (Integer) mutableMapOf.get(Integer.valueOf(range2.getEnd()));
        ...
        if (size3 >= 0) {
            while (true) {
                ...
                Integer num5 = (Integer) mutableMapOf.get(Integer.valueOf(range3.getStart()));
                Intrinsics.checkNotNull(num5);
                int intValue3 = num5.intValue();
                Integer num6 = (Integer) mutableMapOf.get(Integer.valueOf(range3.getEnd()));
