...
public final class AnnotatedStringKt {
    ...
    public static final List<AnnotatedString.Range<ParagraphStyle>> normalizedParagraphStyles(AnnotatedString annotatedString, ParagraphStyle defaultParagraphStyle) {
        ...
        if (size >= 0) {
            ...
            while (true) {
                ...
                arrayList.add(new AnnotatedString.Range(defaultParagraphStyle.merge(component1), component2, i));
                if (i3 > size) {
                    break;
                }
                i2 = i;
        ...
        if (i != length) {
            arrayList.add(new AnnotatedString.Range(defaultParagraphStyle, i, length));
        }
    ...
    private static final List<AnnotatedString.Range<SpanStyle>> getLocalStyles(AnnotatedString annotatedString, int i, int i2) {
        ...
        if (size2 >= 0) {
            while (true) {
                int i6 = i3 + 1;
                AnnotatedString.Range range3 = (AnnotatedString.Range) arrayList2.get(i3);
