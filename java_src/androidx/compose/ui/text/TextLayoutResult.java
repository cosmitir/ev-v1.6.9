...
public final class TextLayoutResult {
    ...
    public final long m1848getSizeYbymL2g() {
        return this.size;
    }
    ...
    public final boolean getDidOverflowHeight() {
        return this.multiParagraph.getDidExceedMaxLines() || ((float) IntSize.m2224getHeightimpl(m1848getSizeYbymL2g())) < this.multiParagraph.getHeight();
    }

    public final boolean getDidOverflowWidth() {
        return ((float) IntSize.m2225getWidthimpl(m1848getSizeYbymL2g())) < this.multiParagraph.getWidth();
    }
    ...
    public final int m1847getOffsetForPositionk4lQ0M(long j) {
        return this.multiParagraph.m1788getOffsetForPositionk4lQ0M(j);
    }
    ...
    public final long m1849getWordBoundaryjx7JFs(int i) {
        return this.multiParagraph.m1789getWordBoundaryjx7JFs(i);
    }
    ...
    public static /* synthetic */ TextLayoutResult m1845copyO0kMr_c$default(TextLayoutResult textLayoutResult, TextLayoutInput textLayoutInput, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            textLayoutInput = textLayoutResult.layoutInput;
        }
        if ((i & 2) != 0) {
            j = textLayoutResult.m1848getSizeYbymL2g();
        }
        return textLayoutResult.m1846copyO0kMr_c(textLayoutInput, j);
    }

    /* renamed from: copy-O0kMr_c  reason: not valid java name */
    public final TextLayoutResult m1846copyO0kMr_c(TextLayoutInput layoutInput, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TextLayoutResult) {
            ...
            if (Intrinsics.areEqual(this.layoutInput, textLayoutResult.layoutInput) && Intrinsics.areEqual(this.multiParagraph, textLayoutResult.multiParagraph) && IntSize.m2223equalsimpl0(m1848getSizeYbymL2g(), textLayoutResult.m1848getSizeYbymL2g())) {
    ...
    public int hashCode() {
        return (((((((((this.layoutInput.hashCode() * 31) + this.multiParagraph.hashCode()) * 31) + IntSize.m2226hashCodeimpl(m1848getSizeYbymL2g())) * 31) + Float.hashCode(this.firstBaseline)) * 31) + Float.hashCode(this.lastBaseline)) * 31) + this.placeholderRects.hashCode();
    }

    public String toString() {
        return "TextLayoutResult(layoutInput=" + this.layoutInput + ", multiParagraph=" + this.multiParagraph + ", size=" + ((Object) IntSize.m2228toStringimpl(m1848getSizeYbymL2g())) + ", firstBaseline=" + this.firstBaseline + ", lastBaseline=" + this.lastBaseline + ", placeholderRects=" + this.placeholderRects + ')';
    }
}
