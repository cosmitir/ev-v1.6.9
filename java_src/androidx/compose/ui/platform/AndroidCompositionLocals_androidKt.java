...
public final class AndroidCompositionLocals_androidKt {
    ...
    public static final void ProvideAndroidCompositionLocals(final AndroidComposeView owner, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i) {
        ...
        Configuration configuration = m1743ProvideAndroidCompositionLocals$lambda1(mutableState);
    ...
    private static final Configuration m1743ProvideAndroidCompositionLocals$lambda1(MutableState<Configuration> mutableState) {
