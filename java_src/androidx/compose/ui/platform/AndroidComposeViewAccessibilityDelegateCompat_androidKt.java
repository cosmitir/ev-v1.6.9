        ...
        if (!isTextField(semanticsNode) || Intrinsics.areEqual(SemanticsConfigurationKt.getOrNull(semanticsNode.getUnmergedConfig$ui_release(), SemanticsProperties.INSTANCE.getFocused()), (Object) true)) {
            LayoutNode findClosestParentNode = findClosestParentNode(semanticsNode.getLayoutNode$ui_release(), new Function1<LayoutNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeViewAccessibilityDelegateCompat_androidKt$excludeLineAndPageGranularities$ancestor$1
                ...
                public final boolean invoke2(LayoutNode it) {
                    ...
                    return Intrinsics.areEqual((Object) (collapsedSemanticsConfiguration2 != null ? Boolean.valueOf(collapsedSemanticsConfiguration2.isMergingSemanticsOfDescendants()) : null), (Object) true) && collapsedSemanticsConfiguration2.contains(SemanticsActions.INSTANCE.getSetText());
                }
            });
            if (findClosestParentNode != null) {
                ...
                if (outerSemantics != null && (collapsedSemanticsConfiguration = outerSemantics.collapsedSemanticsConfiguration()) != null) {
                    bool = (Boolean) SemanticsConfigurationKt.getOrNull(collapsedSemanticsConfiguration, SemanticsProperties.INSTANCE.getFocused());
                }
