...
public final class ViewLayerMatrixCache {
    ...
    public final float[] m1753getMatrixGrdbGEg(View view) {
        Intrinsics.checkNotNullParameter(view, "view");
        float[] fArr = this.matrixCache;
        if (fArr == null) {
            fArr = androidx.compose.ui.graphics.Matrix.m510constructorimpl$default(null, 1, null);
        ...
        if (this.isDirty) {
            ...
            if (!Intrinsics.areEqual(this.androidMatrixCache, matrix)) {
                ...
                AndroidMatrixConversions_androidKt.m230setFromtUYjHk(fArr, matrix);
    ...
    public final float[] m1752getInverseMatrixGrdbGEg(View view) {
        Intrinsics.checkNotNullParameter(view, "view");
        ...
        if (this.isInverseDirty) {
            ...
            if (!Intrinsics.areEqual(this.inverseAndroidMatrixCache, matrix)) {
                Intrinsics.checkNotNullExpressionValue(matrix, "new");
                AndroidMatrixConversions_androidKt.m230setFromtUYjHk(fArr, matrix);
                androidx.compose.ui.graphics.Matrix.m515invertimpl(fArr);
