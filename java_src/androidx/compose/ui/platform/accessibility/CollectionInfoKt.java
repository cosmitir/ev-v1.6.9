...
public final class CollectionInfoKt {
    ...
    private static final boolean calculateIfHorizontallyStacked(List<SemanticsNode> list) {
        ...
        if (list.size() == 0 || list.size() == 1) {
            ...
            if (lastIndex > 0) {
                ...
                while (true) {
                    ...
                    emptyList.add(Offset.m106boximpl(OffsetKt.Offset(Math.abs(Offset.m117getXimpl(semanticsNode4.getBoundsInRoot().m147getCenterF1C5BW0()) - Offset.m117getXimpl(semanticsNode3.getBoundsInRoot().m147getCenterF1C5BW0())), Math.abs(Offset.m118getYimpl(semanticsNode4.getBoundsInRoot().m147getCenterF1C5BW0()) - Offset.m118getYimpl(semanticsNode3.getBoundsInRoot().m147getCenterF1C5BW0())))));
                    if (i >= lastIndex) {
                        break;
                    }
        ...
        if (emptyList.size() == 1) {
            m127unboximpl = ((Offset) CollectionsKt.first((List<? extends Object>) emptyList)).m127unboximpl();
            ...
            if (1 <= lastIndex2) {
                ...
                while (true) {
                    int i3 = i2 + 1;
                    first = Offset.m106boximpl(Offset.m122plusMKHz9U(((Offset) first).m127unboximpl(), ((Offset) emptyList.get(i2)).m127unboximpl()));
                    if (i2 == lastIndex2) {
                        break;
                    }
                    i2 = i3;
            ...
            m127unboximpl = ((Offset) first).m127unboximpl();
        }
        return Offset.m108component2impl(m127unboximpl) < Offset.m107component1impl(m127unboximpl);
    }
