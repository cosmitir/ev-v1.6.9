...
public abstract class Painter {
    ...
    public abstract long mo805getIntrinsicSizeNHjbRc();
    ...
    public static /* synthetic */ void m807drawx_KDEd0$default(Painter painter, DrawScope drawScope, long j, float f, ColorFilter colorFilter, int i, Object obj) {
        if (obj != null) {
        ...
        painter.m808drawx_KDEd0(drawScope, j, f2, colorFilter);
    }

    /* renamed from: draw-x_KDEd0  reason: not valid java name */
    public final void m808drawx_KDEd0(DrawScope receiver, long j, float f, ColorFilter colorFilter) {
        Intrinsics.checkNotNullParameter(receiver, "$receiver");
        configureAlpha(f);
        configureColorFilter(colorFilter);
        configureLayoutDirection(receiver.getLayoutDirection());
        float m186getWidthimpl = Size.m186getWidthimpl(receiver.mo720getSizeNHjbRc()) - Size.m186getWidthimpl(j);
        float m183getHeightimpl = Size.m183getHeightimpl(receiver.mo720getSizeNHjbRc()) - Size.m183getHeightimpl(j);
        receiver.getDrawContext().getTransform().inset(0.0f, 0.0f, m186getWidthimpl, m183getHeightimpl);
        if (f > 0.0f && Size.m186getWidthimpl(j) > 0.0f && Size.m183getHeightimpl(j) > 0.0f) {
            if (this.useLayer) {
                Rect m157Recttz77jQw = RectKt.m157Recttz77jQw(Offset.Companion.m133getZeroF1C5BW0(), SizeKt.Size(Size.m186getWidthimpl(j), Size.m183getHeightimpl(j)));
                Canvas canvas = receiver.getDrawContext().getCanvas();
                try {
                    canvas.saveLayer(m157Recttz77jQw, obtainPaint());
                    onDraw(receiver);
                } finally {
                    canvas.restore();
                }
