...
public final class VectorComponent extends VNode {
    ...
    public VectorComponent() {
        ...
        this.previousDrawSize = Size.Companion.m194getUnspecifiedNHjbRc();
    ...
    public final void draw(DrawScope drawScope, float f, ColorFilter colorFilter) {
        ...
        if (this.isDirty || !Size.m182equalsimpl0(this.previousDrawSize, drawScope.mo720getSizeNHjbRc())) {
            this.root.setScaleX(Size.m186getWidthimpl(drawScope.mo720getSizeNHjbRc()) / this.viewportWidth);
            this.root.setScaleY(Size.m183getHeightimpl(drawScope.mo720getSizeNHjbRc()) / this.viewportHeight);
            this.cacheDrawScope.m809drawCachedImageCJJARo(IntSizeKt.IntSize((int) Math.ceil(Size.m186getWidthimpl(drawScope.mo720getSizeNHjbRc())), (int) Math.ceil(Size.m183getHeightimpl(drawScope.mo720getSizeNHjbRc()))), drawScope, drawScope.getLayoutDirection(), this.drawVectorBlock);
            this.isDirty = false;
            this.previousDrawSize = drawScope.mo720getSizeNHjbRc();
        }
    ...
    public String toString() {
        ...
        sb.append(getViewportHeight()).append(ShellUtils.COMMAND_LINE_END);
