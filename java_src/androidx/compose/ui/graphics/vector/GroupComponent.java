...
public final class GroupComponent extends VNode {
    ...
    private final void updateMatrix() {
        ...
        if (fArr == null) {
            fArr = Matrix.m510constructorimpl$default(null, 1, null);
            this.groupMatrix = fArr;
        } else {
            Matrix.m519resetimpl(fArr);
        }
        Matrix.m530translateimpl$default(fArr, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, null);
        Matrix.m522rotateZimpl(fArr, this.rotation);
        Matrix.m523scaleimpl(fArr, this.scaleX, this.scaleY, 1.0f);
        Matrix.m530translateimpl$default(fArr, -this.pivotX, -this.pivotY, 0.0f, 4, null);
    }
    ...
    public void draw(DrawScope drawScope) {
        ...
        float[] fArr = this.groupMatrix;
        if (fArr != null) {
            transform.mo734transform58bKbWc(fArr);
        }
        Path path = this.clipPath;
        if (getWillClipPath() && path != null) {
            DrawTransform.DefaultImpls.m791clipPathmtrdDE$default(transform, path, 0, 2, null);
        }
        List<VNode> list = this.children;
        int size = list.size() - 1;
        if (size >= 0) {
    ...
    public String toString() {
        ...
        if (size >= 0) {
            ...
            while (true) {
                int i2 = i + 1;
                append.append("\t").append(list.get(i).toString()).append(ShellUtils.COMMAND_LINE_END);
                if (i2 > size) {
                    break;
                }
                i = i2;
