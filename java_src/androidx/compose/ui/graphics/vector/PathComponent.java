...
public final class PathComponent extends VNode {
    ...
    public final int m818getPathFillTypeRgk1Os() {
        return this.pathFillType;
    }

    /* renamed from: setPathFillType-oQ8Xj4U  reason: not valid java name */
    public final void m821setPathFillTypeoQ8Xj4U(int i) {
        this.pathFillType = i;
        this.renderPath.mo252setFillTypeoQ8Xj4U(i);
        invalidate();
    }
    ...
    public final int m819getStrokeLineCapKaPHkGw() {
        return this.strokeLineCap;
    }

    /* renamed from: setStrokeLineCap-BeK7IIE  reason: not valid java name */
    public final void m822setStrokeLineCapBeK7IIE(int i) {
    ...
    public final int m820getStrokeLineJoinLxFBmk8() {
        return this.strokeLineJoin;
    }

    /* renamed from: setStrokeLineJoin-Ww9F2mQ  reason: not valid java name */
    public final void m823setStrokeLineJoinWw9F2mQ(int i) {
    ...
    private final void updateRenderPath() {
        ...
        if (this.trimPathStart == 0.0f) {
            if (this.trimPathEnd == 1.0f) {
                Path.DefaultImpls.m549addPathUv8p0NA$default(this.renderPath, this.path, 0L, 2, null);
                return;
            }
        }
    ...
    public void draw(DrawScope drawScope) {
        ...
        if (brush != null) {
            DrawScope.DefaultImpls.m758drawPathGBMwjPU$default(drawScope, this.renderPath, brush, getFillAlpha(), null, null, 0, 56, null);
        }
        ...
        if (this.isStrokeDirty || stroke == null) {
            stroke = new Stroke(getStrokeLineWidth(), getStrokeLineMiter(), m819getStrokeLineCapKaPHkGw(), m820getStrokeLineJoinLxFBmk8(), null, 16, null);
            this.strokeStyle = stroke;
            this.isStrokeDirty = false;
        }
        DrawScope.DefaultImpls.m758drawPathGBMwjPU$default(drawScope, this.renderPath, brush2, getStrokeAlpha(), stroke, null, 0, 48, null);
    }
