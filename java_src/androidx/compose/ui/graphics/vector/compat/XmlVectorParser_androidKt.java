...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m850getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.Companion.m616getButtKaPHkGw();
        }
        return m849getStrokeLineCapCSYIeUk(i, i2);
    }

    /* renamed from: getStrokeLineCap-CSYIeUk  reason: not valid java name */
    private static final int m849getStrokeLineCapCSYIeUk(int i, int i2) {
        if (i != 0) {
            if (i != 1) {
                return i != 2 ? i2 : StrokeCap.Companion.m618getSquareKaPHkGw();
            }
            return StrokeCap.Companion.m617getRoundKaPHkGw();
        }
        return StrokeCap.Companion.m616getButtKaPHkGw();
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA$default  reason: not valid java name */
    static /* synthetic */ int m852getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.Companion.m627getMiterLxFBmk8();
        }
        return m851getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA  reason: not valid java name */
    private static final int m851getStrokeLineJoinkLtJ_vA(int i, int i2) {
        if (i != 0) {
            if (i != 1) {
                return i != 2 ? i2 : StrokeJoin.Companion.m626getBevelLxFBmk8();
            }
            return StrokeJoin.Companion.m628getRoundLxFBmk8();
        }
        return StrokeJoin.Companion.m627getMiterLxFBmk8();
    }
    ...
    public static final int parseCurrentVectorNode(XmlPullParser xmlPullParser, Resources res, AttributeSet attrs, Resources.Theme theme, ImageVector.Builder builder, int i) {
        ...
        if (eventType == 2) {
            ...
            return i;
        } else if (eventType == 3 && Intrinsics.areEqual(SHAPE_GROUP, xmlPullParser.getName())) {
            int i2 = i + 1;
    ...
    public static final ImageVector.Builder createVectorImageBuilder(XmlPullParser xmlPullParser, Resources res, Resources.Theme theme, AttributeSet attrs) {
        long m382getUnspecified0d7_KjU;
        int m295getSrcIn0nO6VwU;
        Intrinsics.checkNotNullParameter(xmlPullParser, "<this>");
        Intrinsics.checkNotNullParameter(res, "res");
        Intrinsics.checkNotNullParameter(attrs, "attrs");
        ...
        if (namedFloat > 0.0f) {
            ...
            if (obtainAttributes.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
                ...
                if (typedValue.type >= 28 && typedValue.type <= 31) {
                    m382getUnspecified0d7_KjU = ColorKt.Color(typedValue.data);
                } else {
                    m382getUnspecified0d7_KjU = Color.Companion.m382getUnspecified0d7_KjU();
                }
            } else {
                m382getUnspecified0d7_KjU = Color.Companion.m382getUnspecified0d7_KjU();
            }
            long j = m382getUnspecified0d7_KjU;
            int i = obtainAttributes.getInt(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT_MODE(), -1);
            if (i == -1) {
                m295getSrcIn0nO6VwU = BlendMode.Companion.m295getSrcIn0nO6VwU();
            } else if (i == 3) {
                m295getSrcIn0nO6VwU = BlendMode.Companion.m297getSrcOver0nO6VwU();
            } else if (i == 5) {
                m295getSrcIn0nO6VwU = BlendMode.Companion.m295getSrcIn0nO6VwU();
            } else if (i == 9) {
                m295getSrcIn0nO6VwU = BlendMode.Companion.m294getSrcAtop0nO6VwU();
            } else {
                switch (i) {
                    case 14:
                        m295getSrcIn0nO6VwU = BlendMode.Companion.m286getModulate0nO6VwU();
                        break;
                    case 15:
                        m295getSrcIn0nO6VwU = BlendMode.Companion.m291getScreen0nO6VwU();
                        break;
                    case 16:
                        m295getSrcIn0nO6VwU = BlendMode.Companion.m289getPlus0nO6VwU();
                        break;
                    default:
                        m295getSrcIn0nO6VwU = BlendMode.Companion.m295getSrcIn0nO6VwU();
                        break;
            ...
            int i2 = m295getSrcIn0nO6VwU;
            float m2105constructorimpl = Dp.m2105constructorimpl(dimension / res.getDisplayMetrics().density);
            float m2105constructorimpl2 = Dp.m2105constructorimpl(dimension2 / res.getDisplayMetrics().density);
            obtainAttributes.recycle();
            return new ImageVector.Builder(null, m2105constructorimpl, m2105constructorimpl2, namedFloat, namedFloat2, j, i2, 1, null);
        }
    ...
    public static final void parsePath(XmlPullParser xmlPullParser, Resources res, Resources.Theme theme, AttributeSet attrs, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int m849getStrokeLineCapCSYIeUk = m849getStrokeLineCapCSYIeUk(TypedArrayUtils.getNamedInt(obtainAttributes, xmlPullParser, "strokeLineCap", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.Companion.m616getButtKaPHkGw());
        int m851getStrokeLineJoinkLtJ_vA = m851getStrokeLineJoinkLtJ_vA(TypedArrayUtils.getNamedInt(obtainAttributes, xmlPullParser, "strokeLineJoin", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.Companion.m626getBevelLxFBmk8());
        ...
        Brush obtainBrushFromComplexColor2 = obtainBrushFromComplexColor(strokeColor);
        PathFillType.Companion companion = PathFillType.Companion;
        builder.m815addPathoIyEayM(addPathNodes, namedInt == 0 ? companion.m559getNonZeroRgk1Os() : companion.m558getEvenOddRgk1Os(), str, obtainBrushFromComplexColor, namedFloat, obtainBrushFromComplexColor2, namedFloat3, namedFloat4, m849getStrokeLineCapCSYIeUk, m851getStrokeLineJoinkLtJ_vA, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
    }
