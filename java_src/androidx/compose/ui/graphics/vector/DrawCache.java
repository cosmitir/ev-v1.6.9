...
public final class DrawCache {
    ...
    private long size = IntSize.Companion.m2230getZeroYbymL2g();
    ...
    public final void m809drawCachedImageCJJARo(long j, Density density, LayoutDirection layoutDirection, Function1<? super DrawScope, Unit> block) {
        ...
        if (imageBitmap == null || canvas == null || IntSize.m2225getWidthimpl(j) > imageBitmap.getWidth() || IntSize.m2224getHeightimpl(j) > imageBitmap.getHeight()) {
            imageBitmap = ImageBitmapKt.m507ImageBitmapx__hDU$default(IntSize.m2225getWidthimpl(j), IntSize.m2224getHeightimpl(j), 0, false, null, 28, null);
        ...
        long m2235toSizeozmzZPI = IntSizeKt.m2235toSizeozmzZPI(j);
    ...
    public final void drawInto(DrawScope target, float f, ColorFilter colorFilter) {
        ...
        DrawScope.DefaultImpls.m752drawImage9jGpkUE$default(target, imageBitmap, 0L, this.size, 0L, 0L, f, null, colorFilter, 0, 346, null);
    }

    private final void clear(DrawScope drawScope) {
        DrawScope.DefaultImpls.m763drawRectnJ9OG0$default(drawScope, Color.Companion.m372getBlack0d7_KjU(), 0L, 0L, 0.0f, null, null, BlendMode.Companion.m270getClear0nO6VwU(), 62, null);
    }
}
