...
public final class AndroidPath implements Path {
    ...
    public int mo250getFillTypeRgk1Os() {
        if (this.internalPath.getFillType() == Path.FillType.EVEN_ODD) {
            return PathFillType.Companion.m558getEvenOddRgk1Os();
        }
        return PathFillType.Companion.m559getNonZeroRgk1Os();
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: setFillType-oQ8Xj4U  reason: not valid java name */
    public void mo252setFillTypeoQ8Xj4U(int i) {
        Path.FillType fillType;
        android.graphics.Path path = this.internalPath;
        if (PathFillType.m554equalsimpl0(i, PathFillType.Companion.m558getEvenOddRgk1Os())) {
    ...
    public void addRoundRect(RoundRect roundRect) {
        ...
        this.radii[0] = CornerRadius.m92getXimpl(roundRect.m167getTopLeftCornerRadiuskKHJgLs());
        this.radii[1] = CornerRadius.m93getYimpl(roundRect.m167getTopLeftCornerRadiuskKHJgLs());
        this.radii[2] = CornerRadius.m92getXimpl(roundRect.m168getTopRightCornerRadiuskKHJgLs());
        this.radii[3] = CornerRadius.m93getYimpl(roundRect.m168getTopRightCornerRadiuskKHJgLs());
        this.radii[4] = CornerRadius.m92getXimpl(roundRect.m166getBottomRightCornerRadiuskKHJgLs());
        this.radii[5] = CornerRadius.m93getYimpl(roundRect.m166getBottomRightCornerRadiuskKHJgLs());
        this.radii[6] = CornerRadius.m92getXimpl(roundRect.m165getBottomLeftCornerRadiuskKHJgLs());
        this.radii[7] = CornerRadius.m93getYimpl(roundRect.m165getBottomLeftCornerRadiuskKHJgLs());
        this.internalPath.addRoundRect(this.rectF, this.radii, Path.Direction.CCW);
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: addPath-Uv8p0NA  reason: not valid java name */
    public void mo249addPathUv8p0NA(Path path, long j) {
        Intrinsics.checkNotNullParameter(path, "path");
        android.graphics.Path path2 = this.internalPath;
        if (path instanceof AndroidPath) {
            path2.addPath(((AndroidPath) path).getInternalPath(), Offset.m117getXimpl(j), Offset.m118getYimpl(j));
            return;
        }
    ...
    public void mo253translatek4lQ0M(long j) {
        this.mMatrix.reset();
        this.mMatrix.setTranslate(Offset.m117getXimpl(j), Offset.m118getYimpl(j));
    ...
    public boolean mo251opN5in7k0(Path path1, Path path2, int i) {
        Path.Op op;
        Intrinsics.checkNotNullParameter(path1, "path1");
        Intrinsics.checkNotNullParameter(path2, "path2");
        if (PathOperation.m563equalsimpl0(i, PathOperation.Companion.m567getDifferenceb3I0S0c())) {
            op = Path.Op.DIFFERENCE;
        } else if (PathOperation.m563equalsimpl0(i, PathOperation.Companion.m568getIntersectb3I0S0c())) {
            op = Path.Op.INTERSECT;
        } else if (PathOperation.m563equalsimpl0(i, PathOperation.Companion.m569getReverseDifferenceb3I0S0c())) {
            op = Path.Op.REVERSE_DIFFERENCE;
        } else {
            op = PathOperation.m563equalsimpl0(i, PathOperation.Companion.m570getUnionb3I0S0c()) ? Path.Op.UNION : Path.Op.XOR;
        }
        android.graphics.Path path = this.internalPath;
