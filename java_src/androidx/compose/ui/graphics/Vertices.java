...
public final class Vertices {
    ...
    public final int m663getVertexModec2xauaI() {
    ...
    private final float[] encodePointList(List<Offset> list) {
        ...
        for (int i = 0; i < size; i++) {
            long m127unboximpl = list.get(i / 2).m127unboximpl();
            if (i % 2 == 0) {
                m118getYimpl = Offset.m117getXimpl(m127unboximpl);
            } else {
                m118getYimpl = Offset.m118getYimpl(m127unboximpl);
            }
            fArr[i] = m118getYimpl;
        }
        return fArr;
