...
public abstract class ShaderBrush extends Brush {
    ...
    public abstract Shader mo321createShaderuvyYCjk(long j);

    public ShaderBrush() {
        super(null);
        this.createdSize = Size.Companion.m194getUnspecifiedNHjbRc();
    }

    @Override // androidx.compose.ui.graphics.Brush
    /* renamed from: applyTo-Pq9zytI */
    public final void mo300applyToPq9zytI(long j, Paint p, float f) {
        Intrinsics.checkNotNullParameter(p, "p");
        Shader shader = this.internalShader;
        if (shader == null || !Size.m182equalsimpl0(this.createdSize, j)) {
            shader = mo321createShaderuvyYCjk(j);
            this.internalShader = shader;
            this.createdSize = j;
        }
        if (!Color.m347equalsimpl0(p.mo232getColor0d7_KjU(), Color.Companion.m372getBlack0d7_KjU())) {
            p.mo238setColor8_81llA(Color.Companion.m372getBlack0d7_KjU());
        }
