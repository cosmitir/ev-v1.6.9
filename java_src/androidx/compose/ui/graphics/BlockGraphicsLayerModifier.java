...
final class BlockGraphicsLayerModifier extends InspectorValueInfo implements LayoutModifier {
    ...
    public MeasureResult mo39measure3p2s80s(MeasureScope receiver, Measurable measurable, long j) {
        ...
        return MeasureScope.DefaultImpls.layout$default(receiver, mo1607measureBRTryo0.getWidth(), mo1607measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.graphics.BlockGraphicsLayerModifier$measure$1
