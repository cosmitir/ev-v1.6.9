...
public final class ColorSpaceKt {
    ...
    public static /* synthetic */ Connector m679connectYBCOT_4$default(ColorSpace colorSpace, ColorSpace colorSpace2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            colorSpace2 = ColorSpaces.INSTANCE.getSrgb();
        }
        if ((i2 & 2) != 0) {
            i = RenderIntent.Companion.m692getPerceptualuksYyKA();
        }
        return m678connectYBCOT_4(colorSpace, colorSpace2, i);
    }

    /* renamed from: connect-YBCOT_4 */
    public static final Connector m678connectYBCOT_4(ColorSpace connect, ColorSpace destination, int i) {
        Intrinsics.checkNotNullParameter(connect, "$this$connect");
        Intrinsics.checkNotNullParameter(destination, "destination");
        if (connect == destination) {
            return Connector.Companion.identity$ui_graphics_release(connect);
        }
        if (ColorModel.m668equalsimpl0(connect.m677getModelxdoWZVw(), ColorModel.Companion.m675getRgbxdoWZVw()) && ColorModel.m668equalsimpl0(destination.m677getModelxdoWZVw(), ColorModel.Companion.m675getRgbxdoWZVw())) {
    ...
    public static final ColorSpace adapt(ColorSpace colorSpace, WhitePoint whitePoint, Adaptation adaptation) {
        ...
        if (ColorModel.m668equalsimpl0(colorSpace.m677getModelxdoWZVw(), ColorModel.Companion.m675getRgbxdoWZVw())) {
