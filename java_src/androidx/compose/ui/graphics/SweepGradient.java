...
public final class SweepGradient extends ShaderBrush {
    ...
    public Shader mo321createShaderuvyYCjk(long j) {
        ...
        if (OffsetKt.m138isUnspecifiedk4lQ0M(this.center)) {
            Offset = SizeKt.m196getCenteruvyYCjk(j);
        } else {
            Offset = OffsetKt.Offset((Offset.m117getXimpl(this.center) > Float.POSITIVE_INFINITY ? 1 : (Offset.m117getXimpl(this.center) == Float.POSITIVE_INFINITY ? 0 : -1)) == 0 ? Size.m186getWidthimpl(j) : Offset.m117getXimpl(this.center), Offset.m118getYimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m183getHeightimpl(j) : Offset.m118getYimpl(this.center));
        }
        return ShaderKt.m590SweepGradientShader9KIMszo(Offset, this.colors, this.stops);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SweepGradient) {
            ...
            return Offset.m114equalsimpl0(this.center, sweepGradient.center) && Intrinsics.areEqual(this.colors, sweepGradient.colors) && Intrinsics.areEqual(this.stops, sweepGradient.stops);
        }
        return false;
    }

    public int hashCode() {
        int m119hashCodeimpl = ((Offset.m119hashCodeimpl(this.center) * 31) + this.colors.hashCode()) * 31;
        List<Float> list = this.stops;
        return m119hashCodeimpl + (list == null ? 0 : list.hashCode());
    }

    public String toString() {
        return "SweepGradient(" + (OffsetKt.m136isSpecifiedk4lQ0M(this.center) ? "center=" + ((Object) Offset.m125toStringimpl(this.center)) + ", " : "") + "colors=" + this.colors + ", stops=" + this.stops + ')';
    }
}
