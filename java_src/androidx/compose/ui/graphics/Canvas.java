...
public interface Canvas {
    ...
    void mo211clipPathmtrdDE(Path path, int i);

    /* renamed from: clipRect-N_I0leg */
    void mo212clipRectN_I0leg(float f, float f2, float f3, float f4, int i);

    /* renamed from: clipRect-mtrdD-E */
    void mo213clipRectmtrdDE(Rect rect, int i);

    /* renamed from: concat-58bKbWc */
    void mo214concat58bKbWc(float[] fArr);
    ...
    void mo215drawCircle9KIMszo(long j, float f, Paint paint);

    /* renamed from: drawImage-d-4ec7I */
    void mo216drawImaged4ec7I(ImageBitmap imageBitmap, long j, Paint paint);

    /* renamed from: drawImageRect-HPBpro0 */
    void mo217drawImageRectHPBpro0(ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint);

    /* renamed from: drawLine-Wko1d7g */
    void mo218drawLineWko1d7g(long j, long j2, Paint paint);
    ...
    void mo219drawPointsO7TthRY(int i, List<Offset> list, Paint paint);

    /* renamed from: drawRawPoints-O7TthRY */
    void mo220drawRawPointsO7TthRY(int i, float[] fArr, Paint paint);
    ...
    void mo221drawVerticesTPEHhCM(Vertices vertices, int i, Paint paint);
    ...
    public static final class DefaultImpls {
        ...
        public static /* synthetic */ void m325clipRectmtrdDE$default(Canvas canvas, Rect rect, int i, int i2, Object obj) {
            if (obj != null) {
            ...
            canvas.mo213clipRectmtrdDE(rect, i);
        }

        /* renamed from: clipRect-mtrdD-E  reason: not valid java name */
        public static void m324clipRectmtrdDE(Canvas canvas, Rect rect, int i) {
            Intrinsics.checkNotNullParameter(canvas, "this");
            Intrinsics.checkNotNullParameter(rect, "rect");
            canvas.mo212clipRectN_I0leg(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), i);
        }

        /* renamed from: clipRect-N_I0leg$default  reason: not valid java name */
        public static /* synthetic */ void m323clipRectN_I0leg$default(Canvas canvas, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
            if (obj != null) {
            ...
            canvas.mo212clipRectN_I0leg(f, f2, f3, f4, i);
        }

        /* renamed from: clipPath-mtrdD-E$default  reason: not valid java name */
        public static /* synthetic */ void m322clipPathmtrdDE$default(Canvas canvas, Path path, int i, int i2, Object obj) {
            if (obj != null) {
            ...
            canvas.mo211clipPathmtrdDE(path, i);
        }
        ...
        public static /* synthetic */ void m326drawImageRectHPBpro0$default(Canvas canvas, ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint, int i, Object obj) {
            if (obj != null) {
                throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: drawImageRect-HPBpro0");
            }
            long m2193getZeronOccac = (i & 2) != 0 ? IntOffset.Companion.m2193getZeronOccac() : j;
            long IntSize = (i & 4) != 0 ? IntSizeKt.IntSize(imageBitmap.getWidth(), imageBitmap.getHeight()) : j2;
            canvas.mo217drawImageRectHPBpro0(imageBitmap, m2193getZeronOccac, IntSize, (i & 8) != 0 ? IntOffset.Companion.m2193getZeronOccac() : j3, (i & 16) != 0 ? IntSize : j4, paint);
        }
    }
}
