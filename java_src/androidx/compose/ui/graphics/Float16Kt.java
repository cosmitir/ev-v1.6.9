...
public final class Float16Kt {
    ...
    public static final short m479minAoSsdG0(short s, short s2) {
        if (Float16.m451isNaNimpl(s) || Float16.m451isNaNimpl(s2)) {
            return Float16.Companion.m473getNaNslo4al4();
        }
        return Float16.m438compareTo41bOqos(s, s2) <= 0 ? s : s2;
    }

    /* renamed from: max-AoSsdG0  reason: not valid java name */
    public static final short m478maxAoSsdG0(short s, short s2) {
        if (Float16.m451isNaNimpl(s) || Float16.m451isNaNimpl(s2)) {
            return Float16.Companion.m473getNaNslo4al4();
        }
        return Float16.m438compareTo41bOqos(s, s2) >= 0 ? s : s2;
