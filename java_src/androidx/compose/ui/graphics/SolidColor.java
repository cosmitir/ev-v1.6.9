...
public final class SolidColor extends Brush {
    ...
    public final long m598getValue0d7_KjU() {
        return this.value;
    }

    @Override // androidx.compose.ui.graphics.Brush
    /* renamed from: applyTo-Pq9zytI */
    public void mo300applyToPq9zytI(long j, Paint p, float f) {
        long m598getValue0d7_KjU;
        Intrinsics.checkNotNullParameter(p, "p");
        p.setAlpha(1.0f);
        if (!(f == 1.0f)) {
            m598getValue0d7_KjU = Color.m345copywmQWz5c$default(m598getValue0d7_KjU(), Color.m348getAlphaimpl(m598getValue0d7_KjU()) * f, 0.0f, 0.0f, 0.0f, 14, null);
        } else {
            m598getValue0d7_KjU = m598getValue0d7_KjU();
        }
        p.mo238setColor8_81llA(m598getValue0d7_KjU);
        if (p.getShader() != null) {
            p.setShader(null);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof SolidColor) && Color.m347equalsimpl0(m598getValue0d7_KjU(), ((SolidColor) obj).m598getValue0d7_KjU());
    }

    public int hashCode() {
        return Color.m353hashCodeimpl(m598getValue0d7_KjU());
    }

    public String toString() {
        return "SolidColor(value=" + ((Object) Color.m354toStringimpl(m598getValue0d7_KjU())) + ')';
    }
}
