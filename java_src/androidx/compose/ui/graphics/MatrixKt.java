...
public final class MatrixKt {
    ...
    public static final float m533dotp89u6pk(float[] fArr, int i, float[] fArr2, int i2) {
        int i3 = i * 4;
    ...
    */
    public static final boolean m534isIdentity58bKbWc(float[] r7) {
        /*
        ...
        L2a:
            ...
            goto La
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.graphics.MatrixKt.m534isIdentity58bKbWc(float[]):boolean");
    }
}
