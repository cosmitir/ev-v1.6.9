...
public interface OwnedLayer extends GraphicLayerInfo {
    ...
    boolean mo1724isInLayerk4lQ0M(long j);

    void mapBounds(MutableRect mutableRect, boolean z);

    /* renamed from: mapOffset-8S9VItk  reason: not valid java name */
    long mo1725mapOffset8S9VItk(long j, boolean z);

    /* renamed from: move--gyyYBs  reason: not valid java name */
    void mo1726movegyyYBs(long j);

    /* renamed from: resize-ozmzZPI  reason: not valid java name */
    void mo1727resizeozmzZPI(long j);

    void updateDisplayList();

    /* renamed from: updateLayerProperties-dRfWZ4U  reason: not valid java name */
    void mo1728updateLayerPropertiesdRfWZ4U(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape, boolean z, LayoutDirection layoutDirection, Density density);
