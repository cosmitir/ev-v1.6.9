...
public final class RemeasureModifierWrapper extends DelegatingLayoutNodeWrapper<OnRemeasuredModifier> {
    ...
    public Placeable mo1607measureBRTryo0(long j) {
        ...
        Placeable mo1607measureBRTryo0 = super.mo1607measureBRTryo0(j);
        Function0<Unit> function0 = new Function0<Unit>() { // from class: androidx.compose.ui.node.RemeasureModifierWrapper$measure$invokeRemeasureCallbacks$1
            ...
            public final void invoke2() {
                long j2;
                j2 = RemeasureModifierWrapper.this.m1642getMeasuredSizeYbymL2g();
                RemeasureModifierWrapper.this.getModifier().mo1637onRemeasuredozmzZPI(j2);
            }
        };
