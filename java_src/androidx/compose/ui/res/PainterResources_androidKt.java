...
public final class PainterResources_androidKt {
    ...
    public static final Painter painterResource(int i, Composer composer, int i2) {
        ...
        if (Intrinsics.areEqual((Object) (charSequence != null ? Boolean.valueOf(StringsKt.endsWith$default(charSequence, (CharSequence) ".xml", false, 2, (Object) null)) : null), (Object) true)) {
            ...
            composer.endReplaceableGroup();
            BitmapPainter bitmapPainter2 = new BitmapPainter(rememberedValue3, 0L, 0L, 6, null);
            composer.endReplaceableGroup();
