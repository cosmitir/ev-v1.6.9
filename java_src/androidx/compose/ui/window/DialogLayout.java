...
public final class DialogLayout extends AbstractComposeView implements DialogWindowProvider {
    ...
    public DialogLayout(Context context, Window window) {
        ...
        this.window = window;
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ComposableSingletons$AndroidDialog_androidKt.INSTANCE.m2310getLambda1$ui_release(), null, 2, null);
    ...
    public void Content(Composer composer, final int i) {
        Composer startRestartGroup = composer.startRestartGroup(-1628271724);
        ComposerKt.sourceInformation(startRestartGroup, "C(Content)251@9454L9:AndroidDialog.android.kt#2oxthz");
        getContent().invoke(startRestartGroup, 0);
        ScopeUpdateScope endRestartGroup = startRestartGroup.endRestartGroup();
        if (endRestartGroup == null) {
            return;
        }
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.window.DialogLayout$Content$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(2);
