    ...
    public final MeasureResult mo1624measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j) {
        ...
        if (size != 0) {
            ...
            if (size == 1) {
                ...
                return MeasureScope.DefaultImpls.layout$default(Layout, mo1607measureBRTryo0.getWidth(), mo1607measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$SimpleStack$1$measure$2
                    {
                        super(1);
                    }
            ...
            if (size2 >= 0) {
                ...
                while (true) {
                    int i5 = i4 + 1;
                    arrayList.add(measurables.get(i4).mo1607measureBRTryo0(j));
                    if (i5 > size2) {
                        break;
                    }
                    i4 = i5;
            ...
            return MeasureScope.DefaultImpls.layout$default(Layout, i, i2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$SimpleStack$1$measure$3
                ...
                public final void invoke2(Placeable.PlacementScope layout) {
                    ...
                    while (true) {
                        int i10 = i9 + 1;
                        Placeable.PlacementScope.placeRelative$default(layout, arrayList2.get(i9), 0, 0, 0.0f, 4, null);
                        if (i9 == lastIndex2) {
                            return;
                        }
                        i9 = i10;
