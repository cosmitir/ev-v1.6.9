...
public final class SkippableUpdater<T> {
    ...
    public static final /* synthetic */ SkippableUpdater m12boximpl(Composer composer) {
        return new SkippableUpdater(composer);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static <T> Composer m13constructorimpl(Composer composer) {
        Intrinsics.checkNotNullParameter(composer, "composer");
        return composer;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m14equalsimpl(Composer composer, Object obj) {
        return (obj instanceof SkippableUpdater) && Intrinsics.areEqual(composer, ((SkippableUpdater) obj).m19unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m15equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m16hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m17toStringimpl(Composer composer) {
        return "SkippableUpdater(composer=" + composer + ')';
    }

    public boolean equals(Object obj) {
        return m14equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m16hashCodeimpl(this.composer);
    }

    public String toString() {
        return m17toStringimpl(this.composer);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ Composer m19unboximpl() {
    ...
    public static final void m18updateimpl(Composer arg0, Function1<? super Updater<T>, Unit> block) {
        Intrinsics.checkNotNullParameter(arg0, "arg0");
        Intrinsics.checkNotNullParameter(block, "block");
        arg0.startReplaceableGroup(509942095);
        block.invoke(Updater.m20boximpl(Updater.m21constructorimpl(arg0)));
