...
public final class TrieNode<K, V> {
    ...
    private final Object[] bufferMoveEntryToNode(int i, int i2, int i3, K k, V v, int i4, MutabilityOwnership mutabilityOwnership) {
        ...
        return TrieNodeKt.access$replaceEntryWithNode(this.buffer, i, nodeIndex$runtime_release(i2) + 1, makeNode(keyAtIndex == null ? 0 : keyAtIndex.hashCode(), keyAtIndex, valueAtKeyIndex(i), i3, k, v, i4 + 5, mutabilityOwnership));
    }
    ...
    private final boolean collisionContainsKey(K k) {
        ...
        if ((step2 > 0 && first <= last) || (step2 < 0 && last <= first)) {
            while (true) {
                int i = first + step2;
                if (Intrinsics.areEqual(k, this.buffer[first])) {
                    return true;
                }
                if (first == last) {
                    break;
    ...
    private final V collisionGet(K k) {
        ...
        while (true) {
            int i = first + step2;
            if (Intrinsics.areEqual(k, keyAtIndex(first))) {
    ...
    private final TrieNode<K, V> mutableCollisionPutAll(TrieNode<K, V> trieNode, DeltaCounter deltaCounter, MutabilityOwnership mutabilityOwnership) {
        CommonFunctionsKt.m33assert(this.nodeMap == 0);
        CommonFunctionsKt.m33assert(this.dataMap == 0);
        CommonFunctionsKt.m33assert(trieNode.nodeMap == 0);
        CommonFunctionsKt.m33assert(trieNode.dataMap == 0);
        Object[] objArr = this.buffer;
    ...
    private final TrieNode<K, V> mutablePutAllFromOtherNodeCell(TrieNode<K, V> trieNode, int i, int i2, DeltaCounter deltaCounter, PersistentHashMapBuilder<K, V> persistentHashMapBuilder) {
        if (hasNodeAt(i)) {
            ...
            if (hasEntryAt$runtime_release(i)) {
                ...
                int i3 = i2 + 5;
                if (!nodeAtIndex$runtime_release2.containsKey(keyAtIndex2 == null ? 0 : keyAtIndex2.hashCode(), keyAtIndex2, i3)) {
            ...
            return makeNode(keyAtIndex3 == null ? 0 : keyAtIndex3.hashCode(), keyAtIndex3, valueAtKeyIndex2, keyAtIndex4 != null ? keyAtIndex4.hashCode() : 0, keyAtIndex4, trieNode.valueAtKeyIndex(entryKeyIndex$runtime_release4), i2 + 5, persistentHashMapBuilder.getOwnership$runtime_release());
        }
    }
    ...
    public final TrieNode<K, V> mutablePutAll(TrieNode<K, V> otherNode, int i, DeltaCounter intersectionCounter, PersistentHashMapBuilder<K, V> mutator) {
        ...
        if (this == otherNode) {
            ...
            TrieNode<K, V> trieNode = (Intrinsics.areEqual(this.ownedBy, mutator.getOwnership$runtime_release()) && this.dataMap == i6 && this.nodeMap == i2) ? this : new TrieNode<>(i6, i2, new Object[(Integer.bitCount(i6) * 2) + Integer.bitCount(i2)]);
            int i8 = i2;
            int i9 = 0;
            while (i8 != 0) {
                int lowestOneBit2 = Integer.lowestOneBit(i8);
                trieNode.getBuffer$runtime_release()[(trieNode.getBuffer$runtime_release().length - 1) - i9] = mutablePutAllFromOtherNodeCell(otherNode, lowestOneBit2, i, intersectionCounter, mutator);
                i9++;
                i8 ^= lowestOneBit2;
            }
            while (i6 != 0) {
                ...
                if (!otherNode.hasEntryAt$runtime_release(lowestOneBit3)) {
                    ...
                    trieNode.getBuffer$runtime_release()[i10] = keyAtIndex(entryKeyIndex$runtime_release);
                    trieNode.getBuffer$runtime_release()[i10 + 1] = valueAtKeyIndex(entryKeyIndex$runtime_release);
                } else {
                    int entryKeyIndex$runtime_release2 = otherNode.entryKeyIndex$runtime_release(lowestOneBit3);
                    trieNode.getBuffer$runtime_release()[i10] = otherNode.keyAtIndex(entryKeyIndex$runtime_release2);
                    trieNode.getBuffer$runtime_release()[i10 + 1] = otherNode.valueAtKeyIndex(entryKeyIndex$runtime_release2);
    ...
    public final TrieNode<K, V> mutablePut(int i, K k, V v, int i2, PersistentHashMapBuilder<K, V> mutator) {
        ...
        if (hasEntryAt$runtime_release(indexSegment)) {
            ...
            return nodeAtIndex$runtime_release == mutablePut ? this : mutableUpdateNodeAtIndex(nodeIndex$runtime_release, mutablePut, mutator.getOwnership$runtime_release());
        } else {
            mutator.setSize(mutator.size() + 1);
