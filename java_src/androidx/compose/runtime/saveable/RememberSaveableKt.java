...
public final class RememberSaveableKt {
    ...
    public static final <T> T m34rememberSaveable(Object[] inputs, Saver<T, ? extends Object> saver, String str, Function0<? extends T> init, Composer composer, int i, int i2) {
        ...
        if (z || t == Composer.Companion.getEmpty()) {
            t = (saveableStateRegistry == null || (consumeRestored = saveableStateRegistry.consumeRestored(str3)) == null) ? null : saver.restore(consumeRestored);
            if (t == null) {
                t = init.invoke();
            }
    ...
    public static final <T> MutableState<T> rememberSaveable(Object[] inputs, Saver<T, ? extends Object> stateSaver, String str, Function0<? extends MutableState<T>> init, Composer composer, int i, int i2) {
        ...
        MutableState<T> mutableState = (MutableState) m34rememberSaveable(Arrays.copyOf(inputs, inputs.length), (Saver<Object, ? extends Object>) mutableStateSaver(stateSaver), str, (Function0<? extends Object>) init, composer, (i & 896) | 8 | (i & 7168), 0);
        composer.endReplaceableGroup();
        return mutableState;
    }
