...
public final class BroadcastFrameClock implements MonotonicFrameClock {
    ...
    public static final class FrameAwaiter<R> {
        ...
        public final void resume(long j) {
            ...
            try {
                ...
                m2465constructorimpl = Result.m2465constructorimpl(getOnFrame().invoke(Long.valueOf(j)));
            } catch (Throwable th) {
                Result.Companion companion2 = Result.Companion;
                m2465constructorimpl = Result.m2465constructorimpl(ResultKt.createFailure(th));
            }
            continuation.resumeWith(m2465constructorimpl);
        }
    }
    ...
    public final void fail(Throwable th) {
        synchronized (this.lock) {
            ...
            while (i < size) {
                ...
                Result.Companion companion = Result.Companion;
                continuation.resumeWith(Result.m2465constructorimpl(ResultKt.createFailure(th)));
                i = i2;
            }
            this.awaiters.clear();
            Unit unit = Unit.INSTANCE;
    ...
    public <R> Object withFrameNanos(Function1<? super Long, ? extends R> function1, Continuation<? super R> continuation) {
        ...
        synchronized (this.lock) {
            ...
            if (th != null) {
                Result.Companion companion = Result.Companion;
                cancellableContinuationImpl2.resumeWith(Result.m2465constructorimpl(ResultKt.createFailure(th)));
            } else {
