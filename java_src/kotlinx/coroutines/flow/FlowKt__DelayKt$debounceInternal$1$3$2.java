...
@DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__DelayKt$debounceInternal$1$3$2", f = "Delay.kt", i = {0}, l = {CmdConstants.CMD_FILE_PROVIDER_MAKE_URI}, m = "invokeSuspend", n = {"$this$onFailure$iv"}, s = {"L$0"})
...
final class FlowKt__DelayKt$debounceInternal$1$3$2 extends SuspendLambda implements Function2<ChannelResult<? extends Object>, Continuation<? super Unit>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(ChannelResult<? extends Object> channelResult, Continuation<? super Unit> continuation) {
        return m3984invokeWpGqRn0(channelResult.m3973unboximpl(), continuation);
    }

    /* renamed from: invoke-WpGqRn0  reason: not valid java name */
    public final Object m3984invokeWpGqRn0(Object obj, Continuation<? super Unit> continuation) {
        return ((FlowKt__DelayKt$debounceInternal$1$3$2) create(ChannelResult.m3961boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            ?? m3973unboximpl = ((ChannelResult) this.L$0).m3973unboximpl();
            Ref.ObjectRef<Object> objectRef3 = this.$lastValue;
            boolean z = m3973unboximpl instanceof ChannelResult.Failed;
            if (!z) {
                objectRef3.element = m3973unboximpl;
            }
            objectRef = this.$lastValue;
            FlowCollector<T> flowCollector = this.$downstream;
            if (z) {
                Throwable m3965exceptionOrNullimpl = ChannelResult.m3965exceptionOrNullimpl(m3973unboximpl);
                if (m3965exceptionOrNullimpl != null) {
                    throw m3965exceptionOrNullimpl;
                }
