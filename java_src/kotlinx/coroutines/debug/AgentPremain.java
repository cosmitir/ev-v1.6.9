...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m2465constructorimpl = Result.m2465constructorimpl(property == null ? null : Boolean.valueOf(Boolean.parseBoolean(property)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m2465constructorimpl = Result.m2465constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = Result.m2471isFailureimpl(m2465constructorimpl) ? null : m2465constructorimpl;
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m3978installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m3978installSignalHandler$lambda1(Signal signal) {
