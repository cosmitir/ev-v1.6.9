...
public final class SelectBuilderImpl<R> extends LockFreeLinkedListHead implements SelectBuilder<R>, SelectInstance<R>, Continuation<R>, CoroutineStackFrame {
    ...
    private final void doResume(Function0<? extends Object> function0, Function0<Unit> function02) {
        ...
        while (true) {
            ...
            if (obj == SelectKt.access$getUNDECIDED$p()) {
                if (CompositionImpl$$ExternalSyntheticBackportWithForwarding0.m(_result$FU, this, SelectKt.access$getUNDECIDED$p(), function0.invoke())) {
                    return;
                }
            } else if (obj != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                throw new IllegalStateException("Already resumed");
            } else {
                if (CompositionImpl$$ExternalSyntheticBackportWithForwarding0.m(_result$FU, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.access$getRESUMED$p())) {
                    function02.invoke();
                    return;
                }
            }
    ...
    public final Object getResult() {
        ...
        Object obj = this._result;
        if (obj == SelectKt.access$getUNDECIDED$p()) {
            if (CompositionImpl$$ExternalSyntheticBackportWithForwarding0.m(_result$FU, this, SelectKt.access$getUNDECIDED$p(), IntrinsicsKt.getCOROUTINE_SUSPENDED())) {
    ...
    public final void handleBuilderException(Throwable th) {
        if (trySelect()) {
            ...
            resumeWith(Result.m2465constructorimpl(ResultKt.createFailure(th)));
    ...
    public static final class PairSelectOp extends OpDescriptor {
        ...
        public Object perform(Object obj) {
            if (obj != null) {
                ...
                CompositionImpl$$ExternalSyntheticBackportWithForwarding0.m(SelectBuilderImpl._state$FU, selectBuilderImpl, this, decide == null ? this.otherOp.desc : SelectKt.getNOT_SELECTED());
                return decide;
            }
    ...
    public static final class AtomicSelectOp extends AtomicOp<Object> {
        ...
        private final Object prepareSelectOp() {
            ...
            while (true) {
                ...
                if (obj instanceof OpDescriptor) {
                    ...
                    if (CompositionImpl$$ExternalSyntheticBackportWithForwarding0.m(SelectBuilderImpl._state$FU, this.impl, SelectKt.getNOT_SELECTED(), this)) {
                        return null;
                    }
                } else {
        ...
        private final void undoPrepare() {
            CompositionImpl$$ExternalSyntheticBackportWithForwarding0.m(SelectBuilderImpl._state$FU, this.impl, this, SelectKt.getNOT_SELECTED());
        }

        private final void completeSelect(Object obj) {
            boolean z = obj == null;
            if (CompositionImpl$$ExternalSyntheticBackportWithForwarding0.m(SelectBuilderImpl._state$FU, this.impl, this, z ? null : SelectKt.getNOT_SELECTED()) && z) {
    ...
    public void resumeWith(Object obj) {
        ...
        while (true) {
            ...
            if (obj2 == SelectKt.access$getUNDECIDED$p()) {
                if (CompositionImpl$$ExternalSyntheticBackportWithForwarding0.m(_result$FU, this, SelectKt.access$getUNDECIDED$p(), CompletionStateKt.toState$default(obj, null, 1, null))) {
                    return;
                }
                ...
                if (CompositionImpl$$ExternalSyntheticBackportWithForwarding0.m(_result$FU, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.access$getRESUMED$p())) {
                    if (Result.m2471isFailureimpl(obj)) {
                        Continuation<R> continuation = this.uCont;
                        Throwable m2468exceptionOrNullimpl = Result.m2468exceptionOrNullimpl(obj);
                        Intrinsics.checkNotNull(m2468exceptionOrNullimpl);
                        Result.Companion companion = Result.Companion;
                        if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                            m2468exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(m2468exceptionOrNullimpl, (CoroutineStackFrame) continuation);
                        }
                        continuation.resumeWith(Result.m2465constructorimpl(ResultKt.createFailure(m2468exceptionOrNullimpl)));
                        return;
                    }
        ...
        while (true) {
            ...
            if (obj == SelectKt.access$getUNDECIDED$p()) {
                ...
                if (CompositionImpl$$ExternalSyntheticBackportWithForwarding0.m(_result$FU, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.access$getRESUMED$p())) {
                    ...
                    Result.Companion companion = Result.Companion;
                    intercepted.resumeWith(Result.m2465constructorimpl(ResultKt.createFailure(th)));
                    return;
                }
            }
        }
    ...
    */
    public java.lang.Object trySelectOther(kotlinx.coroutines.internal.LockFreeLinkedListNode.PrepareOp r4) {
        ...
        L0:
            ...
            java.lang.Object r1 = kotlinx.coroutines.selects.SelectKt.getNOT_SELECTED()
            boolean r0 = androidx.compose.runtime.CompositionImpl$$ExternalSyntheticBackportWithForwarding0.m(r0, r3, r1, r2)
            if (r0 != 0) goto L31
            goto L0
        L18:
            ...
            boolean r1 = androidx.compose.runtime.CompositionImpl$$ExternalSyntheticBackportWithForwarding0.m(r1, r3, r2, r0)
            if (r1 != 0) goto L2a
            goto L0
        L2a:
