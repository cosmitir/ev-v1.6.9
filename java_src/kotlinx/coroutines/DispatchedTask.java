...
public abstract class DispatchedTask<T> extends Task {
    ...
    public final void run() {
        Object m2465constructorimpl;
        UndispatchedCoroutine<?> undispatchedCoroutine;
        Object m2465constructorimpl2;
        ...
        try {
            ...
            if (job != null && !job.isActive()) {
                ...
                if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                    ...
                    continuation.resumeWith(Result.m2465constructorimpl(ResultKt.createFailure(cancellationException)));
                }
                cancellationException = cancellationException2;
                continuation.resumeWith(Result.m2465constructorimpl(ResultKt.createFailure(cancellationException)));
            } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                Result.Companion companion2 = Result.Companion;
                continuation.resumeWith(Result.m2465constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
            } else {
                T successfulResult$kotlinx_coroutines_core = getSuccessfulResult$kotlinx_coroutines_core(takeState$kotlinx_coroutines_core);
                Result.Companion companion3 = Result.Companion;
                continuation.resumeWith(Result.m2465constructorimpl(successfulResult$kotlinx_coroutines_core));
            }
            ...
            try {
                ...
                m2465constructorimpl2 = Result.m2465constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion5 = Result.Companion;
                m2465constructorimpl2 = Result.m2465constructorimpl(ResultKt.createFailure(th));
            }
            handleFatalException(null, Result.m2468exceptionOrNullimpl(m2465constructorimpl2));
        } catch (Throwable th2) {
            try {
                Result.Companion companion6 = Result.Companion;
                DispatchedTask<T> dispatchedTask2 = this;
                taskContext.afterTask();
                m2465constructorimpl = Result.m2465constructorimpl(Unit.INSTANCE);
            } catch (Throwable th3) {
                Result.Companion companion7 = Result.Companion;
                m2465constructorimpl = Result.m2465constructorimpl(ResultKt.createFailure(th3));
            }
            handleFatalException(th2, Result.m2468exceptionOrNullimpl(m2465constructorimpl));
        }
    }
