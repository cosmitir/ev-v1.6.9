...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m2465constructorimpl = Result.m2465constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.Companion;
                m2465constructorimpl = Result.m2465constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m2471isFailureimpl(m2465constructorimpl)) {
                m2465constructorimpl = null;
            }
            return (E) m2465constructorimpl;
        }
                    ...
                    return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$1
                        ...
                        public final Throwable invoke(Throwable th) {
                            ...
                            try {
                                ...
                                Result.Companion companion2 = Result.Companion;
                                m2465constructorimpl = Result.m2465constructorimpl(ResultKt.createFailure(th2));
                            }
                            if (newInstance != null) {
                                m2465constructorimpl = Result.m2465constructorimpl((Throwable) newInstance);
                                if (Result.m2471isFailureimpl(m2465constructorimpl)) {
                                    m2465constructorimpl = null;
                                }
                                return (Throwable) m2465constructorimpl;
                            }
                    ...
                    return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$3
                        ...
                        public final Throwable invoke(Throwable th) {
                            ...
                            if (newInstance != null) {
                                ...
                                th3.initCause(th);
                                m2465constructorimpl = Result.m2465constructorimpl(th3);
                                if (Result.m2471isFailureimpl(m2465constructorimpl)) {
                                    m2465constructorimpl = null;
                                }
                                return (Throwable) m2465constructorimpl;
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$safeCtor$1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    Result.Companion companion = Result.Companion;
                    m2465constructorimpl = Result.m2465constructorimpl(function12.invoke(th));
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.Companion;
                    m2465constructorimpl = Result.m2465constructorimpl(ResultKt.createFailure(th2));
                }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        Integer m2465constructorimpl;
        JvmClassMappingKt.getKotlinClass(cls);
        try {
            Result.Companion companion = Result.Companion;
            m2465constructorimpl = Result.m2465constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m2465constructorimpl = Result.m2465constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m2471isFailureimpl(m2465constructorimpl)) {
            m2465constructorimpl = valueOf;
        }
        return ((Number) m2465constructorimpl).intValue();
    }
