...
public final class DefaultIoScheduler extends ExecutorCoroutineDispatcher implements Executor {
    ...
    private static final CoroutineDispatcher f10default;
    ...
    static {
        ...
        f10default = unlimitedIoScheduler.limitedParallelism(systemProp$default);
    }
    ...
    public void execute(Runnable runnable) {
        mo4002dispatch(EmptyCoroutineContext.INSTANCE, runnable);
    }
    ...
    public void mo4002dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        f10default.mo4002dispatch(coroutineContext, runnable);
    }
