...
final class ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1<E, R> extends SuspendLambda implements Function2<ChannelResult<? extends E>, Continuation<? super R>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m3977invokeWpGqRn0(((ChannelResult) obj).m3973unboximpl(), (Continuation) obj2);
    }

    /* renamed from: invoke-WpGqRn0  reason: not valid java name */
    public final Object m3977invokeWpGqRn0(Object obj, Continuation<? super R> continuation) {
        return ((ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1) create(ChannelResult.m3961boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Object m3973unboximpl = ((ChannelResult) this.L$0).m3973unboximpl();
            ...
            Object m3966getOrNullimpl = ChannelResult.m3966getOrNullimpl(m3973unboximpl);
            this.label = 1;
            obj = this.$block.invoke(m3966getOrNullimpl, this);
