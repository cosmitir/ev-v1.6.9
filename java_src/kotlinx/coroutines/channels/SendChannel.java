...
public interface SendChannel<E> {
    ...
    Object mo3956trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo3956trySendJP2dKIU = sendChannel.mo3956trySendJP2dKIU(e);
            if (ChannelResult.m3971isSuccessimpl(mo3956trySendJP2dKIU)) {
                return true;
            }
            Throwable m3965exceptionOrNullimpl = ChannelResult.m3965exceptionOrNullimpl(mo3956trySendJP2dKIU);
