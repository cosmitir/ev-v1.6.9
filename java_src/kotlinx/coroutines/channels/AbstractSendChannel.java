...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    */
    ...
    public final Object mo3956trySendJP2dKIU(E e) {
        Object offerInternal = offerInternal(e);
        if (offerInternal == AbstractChannelKt.OFFER_SUCCESS) {
            return ChannelResult.Companion.m3976successJP2dKIU(Unit.INSTANCE);
        }
        if (offerInternal == AbstractChannelKt.OFFER_FAILED) {
            Closed<?> closedForSend = getClosedForSend();
            return closedForSend == null ? ChannelResult.Companion.m3975failurePtdJZtk() : ChannelResult.Companion.m3974closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        } else if (offerInternal instanceof Closed) {
            return ChannelResult.Companion.m3974closedJP2dKIU(helpCloseAndGetSendException((Closed) offerInternal));
        } else {
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        if (function1 != null && (callUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            continuation.resumeWith(Result.m2465constructorimpl(ResultKt.createFailure(undeliveredElementException)));
            return;
        }
        Result.Companion companion2 = Result.Companion;
        continuation.resumeWith(Result.m2465constructorimpl(ResultKt.createFailure(sendException)));
    }
    ...
    private final void invokeOnCloseHandler(Throwable th) {
        ...
        if (obj == null || obj == AbstractChannelKt.HANDLER_INVOKED || !CompositionImpl$$ExternalSyntheticBackportWithForwarding0.m(onCloseHandler$FU, this, obj, AbstractChannelKt.HANDLER_INVOKED)) {
            return;
        }
    ...
    public void invokeOnClose(Function1<? super Throwable, Unit> function1) {
        ...
        if (!CompositionImpl$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, (Object) null, function1)) {
            Object obj = this.onCloseHandler;
        ...
        Closed<?> closedForSend = getClosedForSend();
        if (closedForSend == null || !CompositionImpl$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, function1, AbstractChannelKt.HANDLER_INVOKED)) {
            return;
        }
    ...
    private final void helpClose(Closed<?> closed) {
        ...
        while (true) {
            ...
            if (receive == null) {
                break;
            } else if (!receive.mo4001remove()) {
                receive.helpRemove();
            } else {
                m3993constructorimpl$default = InlineList.m3998plusFjFbRPM(m3993constructorimpl$default, receive);
            }
        }
        if (m3993constructorimpl$default != null) {
            if (!(m3993constructorimpl$default instanceof ArrayList)) {
                ((Receive) m3993constructorimpl$default).resumeReceiveClosed(closed);
            } else if (m3993constructorimpl$default != null) {
                ArrayList arrayList = (ArrayList) m3993constructorimpl$default;
    ...
    */
    ...
    public final Object sendSuspend(E e, Continuation<? super Unit> continuation) {
        ...
        while (true) {
            ...
            if (offerInternal == AbstractChannelKt.OFFER_SUCCESS) {
                Result.Companion companion = Result.Companion;
                cancellableContinuationImpl.resumeWith(Result.m2465constructorimpl(Unit.INSTANCE));
                break;
