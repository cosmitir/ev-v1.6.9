...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    public ReceiveChannel<E> openSubscription() {
        ...
        } while (!CompositionImpl$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj, new State(state.value, addSubscriber(state.subscribers, subscriber))));
        return subscriber;
    }
    ...
    public void invokeOnClose(Function1<? super Throwable, Unit> function1) {
        ...
        if ((obj2 instanceof Closed) && CompositionImpl$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, function1, AbstractChannelKt.HANDLER_INVOKED)) {
    ...
    public Object mo3956trySendJP2dKIU(E e) {
        Closed offerInternal = offerInternal(e);
        if (offerInternal != null) {
            return ChannelResult.Companion.m3974closedJP2dKIU(offerInternal.getSendException());
        }
    ...
    private final Closed offerInternal(E e) {
        ...
        if (_updating$FU.compareAndSet(this, 0, 1)) {
            ...
            } while (!CompositionImpl$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj, new State(e, ((State) obj).subscribers)));
    ...
    public final void closeSubscriber(Subscriber<E> subscriber) {
        ...
        } while (!CompositionImpl$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj, new State(obj2, removeSubscriber(subscriberArr, subscriber))));
    }
    ...
    public boolean cancel(Throwable th) {
        ...
        } while (!CompositionImpl$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj, th == null ? CLOSED : new Closed(th)));
        Subscriber<E>[] subscriberArr = ((State) obj).subscribers;
        if (subscriberArr != null) {
            int length = subscriberArr.length;
            while (i < length) {
