...
@DebugMetadata(c = "kotlinx.coroutines.channels.ProduceKt", f = "Produce.kt", i = {0, 0}, l = {CmdConstants.CMD_CORE_PROVIDER_CREATE}, m = "awaitClose", n = {"$this$awaitClose", "block"}, s = {"L$0", "L$1"})
