...
public class CrashlyticsReportDataCapture {
    ...
    static {
        ...
        GENERATOR = String.format(Locale.US, "Crashlytics Android SDK/%s", "18.3.6");
    }
    ...
    private CrashlyticsReport.Builder buildReportData() {
        return CrashlyticsReport.builder().setSdkVersion("18.3.6").setGmpAppId(this.appData.googleAppId).setInstallationUuid(this.idManager.getCrashlyticsInstallId()).setBuildVersion(this.appData.versionCode).setDisplayVersion(this.appData.versionName).setPlatform(4);
    }
