...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
        ...
        if (TextUtils.isEmpty(charSequence) || onClickListener == null) {
            ...
            actionView.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.snackbar.Snackbar$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view) {
                    Snackbar.this.m2409lambda$setAction$0$comgoogleandroidmaterialsnackbarSnackbar(onClickListener, view);
                }
            });
        }
        return this;
    ...
    public /* synthetic */ void m2409lambda$setAction$0$comgoogleandroidmaterialsnackbarSnackbar(View.OnClickListener onClickListener, View view) {
