...
public final class zzcx extends zzdu {
    ...
    public final void zza() {
        ...
        try {
            ...
            zzcl zzclVar = new zzcl(76003L, Math.max(localVersion, remoteVersion), DynamiteModule.getRemoteVersion(this.zzc, ModuleDescriptor.MODULE_ID) < localVersion, str, str2, str3, this.zzd, com.google.android.gms.measurement.internal.zzfv.zza(this.zzc));
