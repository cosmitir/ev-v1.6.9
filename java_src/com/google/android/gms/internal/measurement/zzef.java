...
public final class zzef {
    ...
    protected zzef(Context context, String str, String str2, String str3, Bundle bundle) {
        ...
        try {
            if (com.google.android.gms.measurement.internal.zzio.zzc(context, "google_app_id", com.google.android.gms.measurement.internal.zzfv.zza(context)) != null && !zzS()) {
                this.zzi = null;
                this.zzh = true;
    ...
    public final void zzC(com.google.android.gms.measurement.internal.zzhe zzheVar) {
        Preconditions.checkNotNull(zzheVar);
        synchronized (this.zzf) {
            for (int i = 0; i < this.zzf.size(); i++) {
                if (zzheVar.equals(((Pair) this.zzf.get(i)).first)) {
                    Log.w(this.zzd, "OnEventListener already registered.");
                    return;
                }
            }
            zzdw zzdwVar = new zzdw(zzheVar);
            this.zzf.add(new Pair(zzheVar, zzdwVar));
            if (this.zzj != null) {
                try {
    ...
    public final void zzP(com.google.android.gms.measurement.internal.zzhe zzheVar) {
        Pair pair;
        Preconditions.checkNotNull(zzheVar);
        synchronized (this.zzf) {
            int i = 0;
            while (true) {
                if (i >= this.zzf.size()) {
                    pair = null;
                    break;
                } else if (zzheVar.equals(((Pair) this.zzf.get(i)).first)) {
