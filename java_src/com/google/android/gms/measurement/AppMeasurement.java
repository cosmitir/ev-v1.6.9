    ...
    public static AppMeasurement getInstance(Context context) {
        ...
        if (zza == null) {
            synchronized (AppMeasurement.class) {
                if (zza == null) {
                    try {
                        zzijVar = (zzij) Class.forName("com.google.firebase.analytics.FirebaseAnalytics").getDeclaredMethod("getScionFrontendApiImplementation", Context.class, Bundle.class).invoke(null, context, null);
                    ...
                    if (zzijVar == null) {
                        ...
                        zza = new AppMeasurement(zzijVar);
                    }
                }
            }
        }
