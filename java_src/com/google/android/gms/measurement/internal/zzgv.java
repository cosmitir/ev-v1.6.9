...
public final class zzgv extends zzei {
    ...
    public final byte[] zzu(zzaw zzawVar, String str) {
        ...
        try {
            ...
            this.zza.zzaA().zzd().zzd("Failed to log and bundle. appId, event, error", zzet.zzn(str), this.zza.zzj().zzd(zzawVar.zza), e);
            return null;
        }
    }
    ...
    public final /* synthetic */ void zzw(String str, Bundle bundle) {
        ...
        try {
            ...
            zzi.zzt.zzaA().zzd().zzc("Error storing default event parameters. appId", zzet.zzn(str), e);
        }
    }
