                ...
                if (zzj == null) {
                    ...
                    try {
                        ...
                        if (zzlkVar == null || zzlkVar.zze == null) {
                            zzlk zzlkVar2 = new zzlk(zzu2, DebugKt.DEBUG_PROPERTY_VALUE_AUTO, "_lte", zzr.zzt.zzax().currentTimeMillis(), 0L);
                            zzu3.add(zzlkVar2);
                        ...
                        if (zzu4.zzt.zzg().zze()) {
                            ...
                            if (zzj.zzak() && zzu4.zzf.zzo().zzn(zzu5)) {
                                ...
                                zzu3.add(new zzlk(zzu5, DebugKt.DEBUG_PROPERTY_VALUE_AUTO, "_npa", zzu4.zzt.zzax().currentTimeMillis(), 1L));
                            }
                        }
                        ...
                        for (int i = 0; i < zzu3.size(); i++) {
                            ...
                            zzd2.zzf(((zzlk) zzu3.get(i)).zzc);
                            zzd2.zzg(((zzlk) zzu3.get(i)).zzd);
                            zzr.zzf.zzu().zzu(zzd2, ((zzlk) zzu3.get(i)).zze);
